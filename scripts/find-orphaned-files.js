 ...
 */
async function main() {
  console.log('🔍 Scanning for orphaned files in documentation...\n');
  ...
  console.log('📋 Analyzing sidebar configuration...');
  ...
  console.log('🔗 Extracting references from documentation files...');
  for (const file of allFiles) {
  ...
  console.log('🔨 Checking build-generated files...');
