 ...
 * Do NOT duplicate those here, they would drift.
 *
 * The values below are maintained by hand. Re-verify them after protocol upgrades: BoLD and
 * similar upgrades redeploy the rollup and fraud-proof contracts, and the SDK is the source of
 * truth for the rollup address while these fraud-proof addresses are not. Precompile addresses
