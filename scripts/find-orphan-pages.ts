...
const dirsAutogeneratedInSidebar: string[] = [];
const resourcesLinkedInSidebar: string[] = [];
const resourcesLinkedInDocs: string[] = [];
const resourcesImportedInDocs: string[] = [];
...
//-----------------------------
//
// Gets the full path to a resource starting from the docs folder (not included)
...
const extractLinksFromMdFile = (filePath: string) => {
  ...
  links.forEach((link: string) => {
    ...
    const resourceFullPath = getFullPathToResource(link, filePath.replace('../docs', ''));
