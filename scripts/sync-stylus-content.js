...
async function syncContent() {
  console.log('🔄 Syncing Stylus by Example content...');
...
`
    ...
    for (const dir of directories) {
      ...
      if (await fs.pathExists(dirPath)) {
        ...
        console.log(`📝 Generated sidebar for ${dir} (${dirFiles.length} items)`);
      }
    }
    
    console.log(`✅ Successfully synced ${successCount}/${files.length} files`);
