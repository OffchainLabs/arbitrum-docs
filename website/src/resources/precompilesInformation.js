const precompilesInformation = {
    ...
    ArbGasInfo: {
        methodOverrides: {
            ...
            getperbatchgascharge: {
                description: 'Returns the base charge (in L1 gas) attributed to each data batch in the calldata pricer',
            },
    ...
    ArbOwner: {
        methodOverrides: {
            ...
            setperbatchgascharge: {
                description: 'Sets the base charge (in L1 gas) attributed to each data batch in the calldata pricer',
            },
    ...
    ArbRetryableTx: {
        methodOverrides: {
            ...
            submitretryable: {
                description: 'Do not call. This method represents a retryable submission to aid explorers. Calling it will always revert.',
            },
        },
        eventOverrides: {
            ticketcreated: {
            ...
            redeemed: {
                description: 'DEPRECATED in favour of new <code>RedeemScheduled</code> event after the nitro upgrade.',
            },
        },
    },
    ArbStatistics: {},
    ArbSys: {
        eventOverrides: {
            ...
            l2tol1transaction: {
                description: 'DEPRECATED in favour of the new <code>L2ToL1Tx</code> event above after the nitro upgrade',
            },
            sendmerkleupdate: {
