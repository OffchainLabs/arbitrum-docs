...
export const NumberComponent = ({ number }) => {
  ...
  // Calculate the offset needed to move from original path position to circle center plus fine-tuning offset
