...
The auctioneer's immediate response allows bidders to know if their bid was accepted before the auction closes. If a bid is rejected, the bidder has an opportunity to correct any issues and submit again before the round closes.
