  ...
  buildDecentralizedAppsSidebar: [
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          id: 'build-decentralized-apps/troubleshooting-building',
        },
        {
          type: 'link',
          label: 'Arbitrum SDK',
    ...
    },
    {
      ...
      items: [
        ...
        {
          type: 'doc',
          id: 'launch-orbit-chain/how-tos/running-an-orbit-node',
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          type: 'html',
          value:
            '<a class="menu__link menu__list-item" href="/launch-orbit-chain/how-tos/running-an-orbit-node">Run a full Orbit node <span class="other-section-icon">↑</span></a>',
          // q: why use an anchor html tag here?
          // a: see note at end of file
        },
        {
