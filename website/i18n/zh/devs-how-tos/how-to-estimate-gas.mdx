...
-   L2G (Gas used on L2) ⇒ Gas used to compute the transaction on L2. This does not include the “_posting on L1”_ part of the calculations. The value of L2G will depend on the transaction itself, but having the data of the transaction, we can calculate it as follows:
