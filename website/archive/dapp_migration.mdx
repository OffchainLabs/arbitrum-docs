...
- **New L2 to L1 event signature**: The function signature for the L2 to L1 event emitted by [ArbSys](/build-decentralized-apps/precompiles/reference#arbsys) has now changed.
...
For addresses of protocol contracts, see [Smart contract addresses](/build-decentralized-apps/reference/useful-addresses).
