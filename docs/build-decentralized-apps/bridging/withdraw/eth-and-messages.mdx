...
For **ERC-20** token withdrawals, see the dedicated [Withdraw tokens guide](/build-decentralized-apps/bridging/withdraw/tokens.mdx), which provides detailed instructions for using Arbitrum's canonical token <a data-quicklook-from="bridge">bridge</a>.
