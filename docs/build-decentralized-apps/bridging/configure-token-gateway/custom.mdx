...
We won't go through the process of deploying custom tokens in this how-to, but you can see a detailed explanation of the steps to take on the [generic-custom gateway setup page](/build-decentralized-apps/bridging/configure-token-gateway/generic-custom.mdx).
