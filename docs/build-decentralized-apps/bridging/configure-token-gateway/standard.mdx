...
- [Generic-custom gateway](/build-decentralized-apps/bridging/configure-token-gateway/generic-custom.mdx)—for custom child chain token logic
- [Custom gateway](/build-decentralized-apps/bridging/configure-token-gateway/custom.mdx)—for advanced use cases
...
For complete deposit instructions, see [Deposit tokens](/build-decentralized-apps/bridging/deposit/tokens.mdx).
...
For these cases, use a [generic-custom gateway](/build-decentralized-apps/bridging/configure-token-gateway/generic-custom.mdx) or a [custom gateway](/build-decentralized-apps/bridging/configure-token-gateway/custom.mdx).
