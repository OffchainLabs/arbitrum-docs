...
- These APIs are just needed for `custom gas token` <a data-quicklook-from="arbitrum-chains">Arbitrum Chains</a> and for **ETH**-powered rollup and AnyTrust Arbitrum chains, you don't need to use them.
