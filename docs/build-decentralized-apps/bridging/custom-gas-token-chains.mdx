...
- These APIs are just needed for [`custom gas token`](/launch-arbitrum-chain/chain-config/costs/custom-gas-token-rollup.mdx) <a data-quicklook-from="arbitrum-chains">Arbitrum Chains</a> and for **ETH**-powered rollup and AnyTrust Arbitrum chains, you don't need to use them.
