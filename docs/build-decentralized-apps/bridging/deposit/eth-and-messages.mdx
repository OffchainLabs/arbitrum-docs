...
description: 'Step-by-step guide to programmatically bridge ETH and send messages from Ethereum (parent chain) to an Arbitrum child chain using retryable tickets and the Inbox contract.'
...
- For bridging tokens programmatically, see [Bridge tokens programmatically](/build-decentralized-apps/bridging/overview.mdx)
