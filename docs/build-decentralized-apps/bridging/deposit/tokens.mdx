...
3. Check that you provided sufficient gas fees for child chain execution — see [How to estimate gas](/build-decentralized-apps/02-how-to-estimate-gas.mdx) for sizing retryable submission and redemption costs
...
- [Configure bridging for a new token](/build-decentralized-apps/bridging/configure-token-gateway/standard.mdx)
