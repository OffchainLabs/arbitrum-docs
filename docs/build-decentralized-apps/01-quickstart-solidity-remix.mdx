...
For a list of learning resources, repositories, and useful information regarding Solidity—see the [Solidity references](/arbitrum-essentials/reference/solidity-references.mdx) page.
