...
You can deploy directly to Arbitrum One using Foundry, and optionally configure [bridging](/build-decentralized-apps/bridging/overview.mdx), liquidity, and supporting <a data-quicklook-from="smart-contract">smart contract</a> infrastructure as part of your token creation.
...
- Use the [Arbitrum Token Bridge](https://bridge.arbitrum.io) to create an L2 counterpart. For a programmatic setup, see the [token bridging guides](/build-decentralized-apps/bridging/overview.mdx).
