...
You can deploy directly to Arbitrum One using Foundry, and optionally configure bridging, liquidity, and supporting <a data-quicklook-from="smart-contract">smart contract</a> infrastructure as part of your token creation.
