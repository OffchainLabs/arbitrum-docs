...
For additional information, see [standard ERC-20 gateway](/how-arbitrum-works/token-bridging/erc20-bridging.mdx#default-standard-bridging) in the conceptual docs.
...
For additional information, see [Arbitrum generic custom gateway](/how-arbitrum-works/token-bridging/erc20-bridging.mdx#the-arbitrum-generic-custom-gateway) in the conceptual docs.
...
For additional information, see [other types of gateways](/how-arbitrum-works/token-bridging/erc20-bridging.mdx#other-flavors-of-gateways) in the conceptual docs.
...
- [Token bridge architecture](/how-arbitrum-works/token-bridging/overview.mdx)
