...
- Familiarity with [Arbitrum's token bridge system](/how-arbitrum-works/token-bridging/overview.mdx)
...
For architectural details, see [Standard ERC-20 bridging](/how-arbitrum-works/token-bridging/erc20-bridging.mdx#default-standard-bridging).
...
- [Token bridge conceptual overview](/how-arbitrum-works/token-bridging/overview.mdx)
- [Standard ERC-20 bridging details](/how-arbitrum-works/token-bridging/erc20-bridging.mdx#default-standard-bridging)
