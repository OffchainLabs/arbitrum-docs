...
To simplify the process, we’ll use Arbitrum’s SDK and call the method [`registerCustomToken`](../../sdk-docs/reference/assetBridger/erc20Bridger#registercustomtoken) of the [`AdminErc20Bridger`](../../sdk-docs/reference/assetBridger/erc20Bridger#adminerc20bridger) class, which will call the `registerTokenOnL2` method of the token passed by parameter.
