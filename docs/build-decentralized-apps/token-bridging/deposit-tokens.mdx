...
- Familiarity with [Arbitrum's token bridge architecture](/how-arbitrum-works/token-bridging/overview.mdx)
...
For more details on the underlying protocol, see [Token bridging overview](/how-arbitrum-works/token-bridging/overview.mdx).
