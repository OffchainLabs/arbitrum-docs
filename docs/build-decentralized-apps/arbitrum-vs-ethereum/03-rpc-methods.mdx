...
:::tip Looking for the full method list?

For the complete catalog of JSON-RPC namespaces and methods exposed by Nitro nodes (`eth`, `net`, `txpool`, `debug`, `web3`, `arbtrace`), see [JSON-RPC method support](/build-decentralized-apps/reference/json-rpc-methods.mdx).
