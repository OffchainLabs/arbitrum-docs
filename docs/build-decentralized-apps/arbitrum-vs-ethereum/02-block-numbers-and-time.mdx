...
- **Parent chain block numbers** (accessed via `block.number`): Updated approximately every 12 seconds but may not reflect the exact parent chain block at the time of your transaction.
