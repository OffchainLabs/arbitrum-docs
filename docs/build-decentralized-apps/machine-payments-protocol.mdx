...
`mppx` itself is payment-method-agnostic. This plugin provides the methods for settling payments on Arbitrum One or Arbitrum Sepolia using **ERC-20** stablecoins (currently **USDC**) using [EIP-3009](https://eips.ethereum.org/EIPS/eip-3009) `authorization` and almost any **ERC-20** via `permit2`.
