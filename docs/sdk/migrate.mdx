...
| `Network`             | _removed_                                                                                |
| `L1Network`           | _removed_                                                                                |
| `getL1Network`        | _removed_                                                                                |
| `getParentForNetwork` | _removed_                                                                                |
...
| `explorerUrl`         | _removed_       |
| `isArbitrum`          | _removed_       |
| `partnerChainIDs`     | _removed_       |
| `nitroGenesisBlock`   | _removed_       |
| `nitroGenesisL1Block` | _removed_       |
| `depositTimeout`      | _removed_       |
| `blockTime`           | _removed_       |
