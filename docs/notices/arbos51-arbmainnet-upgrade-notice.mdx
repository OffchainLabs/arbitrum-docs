...
user_story: As an Arbitrum chain owner or node operator, I want to keep my chain/nodes in sync with Arbitrum One & Arbitrum Nova after the ArbOS 51 activation.
content_type: notice
---
