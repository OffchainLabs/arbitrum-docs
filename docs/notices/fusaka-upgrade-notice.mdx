...
Note (*)
- >=`3.8.0` is required for L2 batch posters settling to a fusaka enabled parent chain
- >=`3.8.0` is required for L2 & L3 AnyTrust / AltDA chains that use chunked data
