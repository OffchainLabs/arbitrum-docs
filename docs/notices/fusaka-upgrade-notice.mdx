...
| Date                              | Network upgrade                                                                            |
| --------------------------------- | ------------------------------------------------------------------------------------------ |
| `October 14th 2025, 07:36:00 UTC` | Ethereum Sepolia Fusaka hard fork                                                          |
| `Dec 3rd 2025, 21:49:11 UTC`      | Ethereum Mainnet Fusaka hard fork                                                          |
| `Dec 20th 2025, 17:00:00 UTC`     | Arbitrum Sepolia upgrade to [ArbOS 50](docs/run-arbitrum-node/arbos-releases/arbos50.mdx)  |
| N/A                               | Arbitrum One/Nova upgrade to [ArbOS 50](docs/run-arbitrum-node/arbos-releases/arbos50.mdx) |
