...
ArbOS 51 is a follow-up to [ArbOS 50](docs/run-arbitrum-node/arbos-releases/arbos50.mdx) and includes the activation for multidimensional-pricing instrumentation. ArbOS 50 was previously activated on Sepolia, but the Gas Target & Pricing Framework changes remained disabled pending a fix. ArbOS 51 now completes that work.
