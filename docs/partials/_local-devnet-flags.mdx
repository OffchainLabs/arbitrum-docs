...
title: 'Local Development Network Flags'
description: 'Command-line flags for local Arbitrum development network setup'
author: anegg0
...
| `--simple`                | Runs a simple configuration: one node as a sequencer/batch-poster/bonder (default unless using `--dev`) |
