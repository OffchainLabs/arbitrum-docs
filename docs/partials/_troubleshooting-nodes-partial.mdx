...
<p>
  ...
  compare it with information on <a href="https://arbiscan.io/">Arbiscan</a> (please note that the
  search function on Arbiscan does not support searches by block hash).
</p>
