...
A permissioned set of parties responsible for enforcing data availability on a chain using the
[Arbitrum AnyTrust Protocol](/intro/glossary/#arbitrum-anytrust-protocol).
