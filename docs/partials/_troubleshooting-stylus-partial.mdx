...
Some of the first Stylus examples were built and deployed using a previous version of [cargo-stylus](https://github.com/OffchainLabs/stylus-sdk-rs/tree/main/cargo-stylus) (`0.1.x`). In that version, Stylus projects were structured as regular Rust binaries.
...
The [cargo-stylus tool](https://github.com/OffchainLabs/stylus-sdk-rs/tree/main/cargo-stylus/tree/main#exporting-solidity-abis) has a command that allows you to export the ABI of your Stylus contract: `cargo stylus export-abi`.
