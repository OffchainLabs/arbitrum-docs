...
- Parties with significant assets at bond on a chain, such as <a data-quicklook-from="app">app</a> developers, exchanges, power users, and liquidity providers, may choose to validate in order to protect their investment.
