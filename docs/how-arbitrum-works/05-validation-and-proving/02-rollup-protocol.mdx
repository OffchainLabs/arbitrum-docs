...
- Parties with significant assets at bond on a chain, such as <a data-quicklook-from="dapp">decentralized app</a> developers, exchanges, power users, and liquidity providers, may choose to validate in order to protect their investment.
...
- **Asset protection**: <a data-quicklook-from="dapp">app</a> developers, exchanges, and liquidity providers may validate the chain to protect their holdings.
