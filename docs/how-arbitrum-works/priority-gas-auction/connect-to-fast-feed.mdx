...
description: 'Generate an API key, deposit USDG, buy a ticket each round from the Tickets contract, and open an authenticated WebSocket to the Fast Feed on Arbitrum One.'
author: anegg0
sme: gligneul
user_story: As a developer who runs a latency-sensitive strategy on Arbitrum One, I want to connect my client to the Fast Feed and keep it connected across rounds.
content_type: how-to
---
...
An earlier deployment at `0xf7aC1f3Ea621519D8629ccC1E4Be3ef5Cd6130d2` was abandoned before launch. Do not deposit funds there. Use only the `Tickets` address in the table above.
