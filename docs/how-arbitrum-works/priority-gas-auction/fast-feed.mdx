...
The Arbitrum Treasury Management (ATM) Council and OAT selected USDG as the stablecoin. All contract addresses appear on the [contract addresses page](/arbitrum-essentials/reference/contract-addresses) once the contracts are live.
