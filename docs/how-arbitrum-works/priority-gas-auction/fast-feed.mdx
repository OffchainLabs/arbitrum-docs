...
For the contract calls, the WebSocket handshake, the reference purchase bot, and the errors you can hit, see [how to use the Fast Feed](/how-arbitrum-works/priority-gas-auction/use-fast-feed).
...
The Arbitrum Treasury Management (ATM) Council and OAT selected USDG as the stablecoin. The `Tickets` and USDG addresses are listed in [how to use the Fast Feed](/how-arbitrum-works/priority-gas-auction/use-fast-feed#addresses-and-endpoints).
