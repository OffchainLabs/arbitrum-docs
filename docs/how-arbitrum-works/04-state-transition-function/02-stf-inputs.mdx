...
- `L2MessageType_unsignedEOATx` (0): Child chain messages submitted by <a data-quicklook-from="externally-owned-accounts">Externally Owned Accounts</a> (EOAs)
  to the parent chain that does not include a signature.
