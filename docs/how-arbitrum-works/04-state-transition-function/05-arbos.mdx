...
******************************************************
******************************************************
Not sure this is more relevant or expansive than the existing information from "Inside Arbitrum Nitro" it's more a deep explanation of how the precompiles themselves work. If we were to keep this content, I firmly believe it would make more sense to move this to the [Precompiles](/build-decentralized-apps/precompiles/01-overview.mdx)
******************************************************
******************************************************
******************************************************
...
******************************************************
******************************************************
Based on current feedback from the AI Assistant it seems there are a ton of questions about gas - and the content around gas is scattered in multiple places. I am of the belief that we need a page that contains all the gassy information we can combine in a logical way without stripping it out of logical places - maybe partialize them.
******************************************************
******************************************************
******************************************************
