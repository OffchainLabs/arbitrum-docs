...
******************************************************
******************************************************
This seems like it may be a good candidate to move to /build-decentralized-apps/arbitrum-vs-ethereum/01-comparison-overview.mdx
******************************************************
******************************************************
******************************************************
...
the below can be reused into a deep dive for the Geth Sandwich
