...
The key principle behind interactive proving is that if Alice and Bob are in a dispute, they should perform as much off-chain work as possible to resolve it, rather than delegating that work to a Layer 1 (L1) contract.
