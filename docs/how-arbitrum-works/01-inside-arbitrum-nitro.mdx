...
- If you're staked on an assertion, you can also add your stake to any one successor of that assertion. (The protocol tracks the maximum assertion number you're staked on, and let's you add your stake to any successor of that assertion, updating your maximum to that successor.) This doesn't require you to place a new stake.
