...
1. **Message Creation**: A contract or user sends a message from the child chain by calling: [`ArbSys.sendTxToL1()`](/build-decentralized-apps/precompiles/02-reference.mdx#arbsys)
...
For more in-depth information about Stylus, refer to the [Stylus Gentle Intro](/stylus/gentle-introduction.mdx).
...
For more information about Timeboost, refer to the [Timeboost Gentle introduction](/how-arbitrum-works/timeboost/gentle-introduction.mdx).
...
For more in-depth information about AnyTrust, refer to the [AnyTrust protocol](/how-arbitrum-works/deep-dives/anytrust-protocol.mdx).
