...
- **Advanced <a data-quicklook-from="blob">blob</a>/calldata compression** further reduces <a data-quicklook-from="transaction">transaction</a> costs on Arbitrum by reducing the amount of data posted to L1.
