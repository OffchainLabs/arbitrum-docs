...
ArbOS processes incoming [sequencer data batches](/how-arbitrum-works/deep-dives/sequencer.mdx#posting-to-the-parent-chain) to produce child chain blocks, ensuring the state is updated correctly.
