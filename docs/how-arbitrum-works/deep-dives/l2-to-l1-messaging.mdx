...
For implementation details, see [Withdrawing `ETH`](/build-decentralized-apps/bridging/withdraw/eth-and-messages.mdx#withdrawing-eth).
...
For implementation details, see [Withdrawing `ERC-20` tokens](/build-decentralized-apps/bridging/withdraw/eth-and-messages.mdx#withdrawing-erc-20-tokens).
