...
published in real time. To learn more, refer to the [real-time sequencer feed documentation](/how-arbitrum-works/deep-dives/sequencer.mdx#real-time-sequencer-feed).
...
As discussed in the [considerations and limitations section](/how-arbitrum-works/deep-dives/sequencer.mdx#considerations-and-limitations), these methods may be more appropriate for different applications depending on their specific requirements.
...
For more details on message types beyond standard child chain transactions, please refer to the [parent-to-child chain messaging documentation](/how-arbitrum-works/deep-dives/l1-to-l2-messaging.mdx).
