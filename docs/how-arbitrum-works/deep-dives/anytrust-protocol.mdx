...
In regular Arbitrum Nitro, the Arbitrum [<a data-quicklook-from="sequencer">Sequencer</a>](/how-arbitrum-works/deep-dives/sequencer.mdx) posts data blocks on the parent chain as [blobs or calldata](/how-arbitrum-works/deep-dives/sequencer.mdx#1-receipt-and-admission). The hashes of the data blocks are committed to the parent chain Inbox contract, allowing the data to be reliably read by the child chain code.
