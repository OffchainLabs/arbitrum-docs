...
- [Finality](#finality): A summary of the soft and hard finality levels, with a pointer to the full [Finality](/how-arbitrum-works/deep-dives/finality.mdx) page (not a Sequencer task).
