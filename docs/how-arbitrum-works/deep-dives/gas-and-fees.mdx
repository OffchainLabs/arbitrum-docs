...
For detailed formulas and technical specifics of parent chain pricing algorithms, including the dynamic pricing mechanism and cost allocation formulas, see the [Parent chain pricing](/how-arbitrum-works/reference/parent-chain-pricing.mdx) page.
