...
:::tip For detailed mathematical treatment

For comprehensive mathematical formulas and technical details of parent chain pricing algorithms, including the dynamic pricing mechanism and cost allocation formulas, see [Parent chain pricing](/how-arbitrum-works/reference/parent-chain-pricing.mdx).
