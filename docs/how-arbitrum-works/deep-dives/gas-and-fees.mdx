...
Whether a tip does anything depends on the chain's <a data-quicklook-from="transaction-ordering-policy">transaction ordering policy</a> and on whether the chain collects tips at all. Two settings control this, and a chain needs both before a tip changes anything:
