...
Child chain gas fees work similarly to Ethereum: a transaction consumes gas, which is multiplied by the current basefee to determine the child chain gas fee.
