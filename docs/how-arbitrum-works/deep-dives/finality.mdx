...
| Full settlement (assertion confirmed)                         | L2 state is finalized and L2→L1 withdrawals can be executed                             | A bounded challenge period under BoLD, on the order of days on mainnet                          |
