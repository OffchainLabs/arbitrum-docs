...
- **Challenge period:** Window of time ([6.4 days on Arbitrum One](/arbitrum-essentials/reference/chain-params.mdx)) over which an assertion can be challenged, after which the assertion can be confirmed. This is configurable by the DAO.
