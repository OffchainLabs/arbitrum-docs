...
![Ed's Original Napkin Drawing](eds-napkin-drawing.png)
...
![Transaction Lifecycle](og-transaction-lifecycle.png)
...
![Normal Rollup Chain](og-normal-rollup-chain.png)
...
![Malicious Rollup Chain](og-malicious-rollup-chain.png)
...
![Rollup Challenges](rollup-challenges.png)
