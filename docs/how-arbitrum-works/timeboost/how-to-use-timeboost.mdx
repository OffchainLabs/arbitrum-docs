...
Timeboost is a new transaction ordering policy for Arbitrum chains. With Timeboost, anyone can bid for the right to access an express lane on the [**Sequencer**](/how-arbitrum-works/deep-dives/sequencer.mdx) for faster transaction inclusion.
