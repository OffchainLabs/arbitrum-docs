...
## How to query the Reserve Pricer API
...
Before submitting a bid, query the [Reserve Pricer API](#how-to-query-the-reserve-pricer-api) to retrieve the minimum acceptable bid amount for the round you're bidding on.
