...
To support these additional use-cases, follow the instructions described in [How to customize your Arbitrum chain's behavior](../../05-customize-your-chain/customize-stf.mdx).
...
Next, follow the steps in [How to customize your Arbitrum chain's behavior](../../05-customize-your-chain/customize-stf.mdx#step-3-run-the-node-without-fraud-proofs) to build a modified Arbitrum Nitro node Docker image and run it.
