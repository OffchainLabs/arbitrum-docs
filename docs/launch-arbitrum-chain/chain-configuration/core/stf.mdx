...
Next, make your changes to the State Transition Function. For example, you could [add a custom precompile](../../chain-config/core/precompiles.mdx).

After this step, you should visit [Customize ArbOS version](../../chain-config/core/arbos.mdx) to see if your changes need to upgrade the ArbOS version. If so, please continue
