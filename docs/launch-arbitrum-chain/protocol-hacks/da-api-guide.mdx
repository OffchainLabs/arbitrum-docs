...
- **Fraud-proof compatible**: Full support for [BoLD](/how-arbitrum-works/bold/gentle-introduction.mdx) <a data-quicklook-from="challenge">challenge</a> protocol and fraud proofs
...
- **Normal execution**: [Batch Poster](/how-arbitrum-works/deep-dives/assertions.mdx) stores data -> generates certificate -> posts to <a data-quicklook-from="l1">L1</a>
...
Returns the header byte that identifies your DA provider in [Sequencer](/how-arbitrum-works/deep-dives/sequencer.mdx) messages.
...
You can deploy a RollupCreator factory contract following the instructions in [How to deploy new factory contracts](/launch-arbitrum-chain/deploy/canonical-factory-contracts.mdx#deploying-a-rollupcreator).
