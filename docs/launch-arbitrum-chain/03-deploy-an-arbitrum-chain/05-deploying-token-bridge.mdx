...
- Learning about the canonical token bridge in the [Token bridging](/how-arbitrum-works/token-bridging/overview.mdx) section
...
You can find more info about `WETH` gateways in our ["other gateways flavors" documentation](/how-arbitrum-works/token-bridging/erc20-bridging.mdx#other-flavors-of-gateways).
