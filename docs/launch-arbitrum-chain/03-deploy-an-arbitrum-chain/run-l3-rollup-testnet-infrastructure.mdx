...
| :--------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Deployed chain**     | Complete [Run an L3 rollup from scratch](/launch-arbitrum-chain/run-l3-rollup-from-scratch.mdx), Steps 1–4 (deploy, generate config, fund batch poster and validator), **do not complete Step 5** |
