...
The validator validates blocks and posts [assertions](/how-arbitrum-works/deep-dives/assertions.mdx) to the parent chain. It is required for chain security. The validator wallet needs **ETH** on the parent chain (Arbitrum Sepolia) for gas.
