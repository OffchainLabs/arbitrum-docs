...
If you do not customize the precompile before launching your Arbitrum chain network, please continue to follow the instructions on [Customize ArbOS](../chain-configuration/core/arbos.mdx) to perform an ArbOS version control to avoid blockchain reorg.
