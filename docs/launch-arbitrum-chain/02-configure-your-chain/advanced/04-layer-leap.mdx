...
2. **Implement the bridging flow**
   ...
   The simplest implementation uses the [Arbitrum SDK](https://www.npmjs.com/package/@arbitrum/sdk) (`Erc20L1L3Bridger` from `@arbitrum/sdk`):
...
const result = await l1l3Bridger.deposit({
  erc20L1Address: erc20Address, // Token address on L1
...
console.log(`Teleport completed: ${status.completed}`);
```
...
- [SDK documentation](https://www.npmjs.com/package/@arbitrum/sdk)
