...
As a RaaS or Chain Owner, if you require internal daily reporting on fees, we have an
[RPC script you can leverage for reporting purposes](https://github.com/yahgwai/aep-fee-tracker/).
