...
Yes. [Ethereal](https://docs.ethereal.trade/), a high-performance perp DEX appchain, is a notable live implementation. They utilize the native mint/burn functionality in partnership with LayerZero to provide seamless bridging for their native gas token.
