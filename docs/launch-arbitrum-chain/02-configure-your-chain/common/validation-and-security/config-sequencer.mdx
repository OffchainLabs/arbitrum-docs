...
- **Customization**: Tune parameters such as `max-tx-data-size` and batch sizes to match your chain’s throughput needs. For DA alternatives (e.g., Celestia), update aggregator URLs accordingly.
