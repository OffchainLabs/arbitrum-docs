...
This is the default option for chains that demand security. Transaction data is posted to the parent chain as calldata or blobs (after [EIP-4844](https://eips.ethereum.org/EIPS/eip-4844)), using Ethereum's DA layer.
