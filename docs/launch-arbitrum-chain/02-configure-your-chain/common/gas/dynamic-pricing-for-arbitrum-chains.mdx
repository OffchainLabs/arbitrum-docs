...
<a data-quicklook-from="arbitrum-chain">Arbitrum chains</a> support a new gas pricing algorithm that
uses multiple-gas targets, as part of the [ArbOS 51 upgrade](/run-arbitrum-node/arbos-releases/arbos51),
to reduce the frequency and severity of child-chain gas price spikes. This is the first optimization
of many towards Dynamic Pricing.
...
<a data-quicklook-from="offchain-labs">Offchain Labs</a> has developed a [script to help calculate pricing
constraints](https://colab.research.google.com/drive/1D28YghOmCjvvrLWS5FsTp5xNKz9JHAA3?usp=sharing),
which takes in certain parameters to find the most optimized gas targets to use for your chain. The script
