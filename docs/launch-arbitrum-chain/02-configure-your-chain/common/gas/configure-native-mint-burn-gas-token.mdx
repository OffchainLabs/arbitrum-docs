...
While Native Mint/Burn was introduced in [ArbOS](/how-arbitrum-works/deep-dives/arbos.mdx) 41, we strongly recommend that teams upgrade to [ArbOS 51 Dia](/run-arbitrum-node/arbos-releases/arbos51) to enable this feature.
