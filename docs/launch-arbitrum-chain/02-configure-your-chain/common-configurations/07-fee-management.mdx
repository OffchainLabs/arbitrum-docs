...
:::important
Before calling `setFeeCollector()`, you must ensure the batch poster address is already registered in the BatchPostersTable. This happens either by:

- Manually calling `addBatchPoster()` for the address, or
