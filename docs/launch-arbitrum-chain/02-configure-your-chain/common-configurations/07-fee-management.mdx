...
:::important
Before calling `ArbAggregator.setFeeCollector()`, you must ensure the batch poster address is already registered in the BatchPostersTable. This happens either by:
