...
- `long_term_adjustment_window_seconds` \- The maximum timeframe over which gas prices adjust. This window specifically applies to the **lowest gas target** to ensure price stability during low-demand periods.
...
The launch of this new pricing algorithm (the first optimization towards Dynamic Pricing) has already been completed for Arbitrum One as of Jan 8, 2026. We recommend waiting for at least 30 days after ArbOS 51 upgrade on Arbitrum One before upgrading your chain. Post upgrading to ArbOS 51, you can set the parameters to enable the new pricing algorithm\. We recommend this waiting period to ensure the changes are stable and work effectively before having other chains adopt it.
