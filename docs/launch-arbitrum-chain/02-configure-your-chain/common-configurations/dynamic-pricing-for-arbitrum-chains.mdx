...
Arbitrum chains are going to be using a new gas pricing algorithm that uses multiple-gas targets, as part of the [ArbOS 51 upgrade](https://docs.arbitrum.io/run-arbitrum-node/arbos-releases/arbos51) to reduce the frequency and severity of child chain gas price spikes. This is the first optimization of many towards Dynamic Pricing.

- **Key Action:** We recommend waiting for 30 days before enabling the new gas targets for your own chain. _[Updated: 8th Jan 2025]_
