...
Refer to the [Chain parameters](/build-decentralized-apps/reference/03-chain-params.mdx) page, or the [Additional configuration parameters](/launch-arbitrum-chain/reference/additional-configuration-parameters.md) for additional information.
...
- **Default**: 0.01 `gwei` (10,000,000 `wei`).
- **Configuration**:
...
- **Default**: Varies based on parent chain fees, but typically around 100,000 gas (adjustable to match).
