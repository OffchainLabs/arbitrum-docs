...
For [Arbitrum AnyTrust chains](/how-arbitrum-works/deep-dives/anytrust-protocol.mdx), the Nitro node configuration object has an additional segment under the `node` field to configure the AnyTrust specific properties:
