...
You can use these contracts to create Arbitrum chains. However, it is strongly recommended to go through the [Chain SDK](/launch-arbitrum-chain/quickstart/sdk-introduction.mdx) to interact with them. Doing so prevents misconfiguring parameters and using appropriate defaults for most of them.
...
- `@@maxDataSizeL2=117964@@` is the parent chain is Ethereum
- `@@maxDataSizeL3=104857@@` if the parent chain is a Layer 2 chain
