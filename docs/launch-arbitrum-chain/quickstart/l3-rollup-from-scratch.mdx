...
- For production chains, customization, and more details, see the [full deployment guide](/launch-arbitrum-chain/deploy/deploy-chain.mdx), [node config guide](/launch-arbitrum-chain/deploy/configure-node.mdx), and [token bridge guide](/launch-arbitrum-chain/03-deploy-an-arbitrum-chain/05-deploying-token-bridge.mdx).
