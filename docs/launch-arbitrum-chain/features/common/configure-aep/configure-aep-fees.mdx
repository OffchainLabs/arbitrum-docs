...
- **Validation**: No impact on [BoLD](/how-arbitrum-works/bold/gentle-introduction.mdx) or permissioned setups.
...
This is an abbreviated set of instructions on how to configure AEP fees. For a complete set of instructions refer to the [AEP fee router introduction](/launch-arbitrum-chain/chain-config/costs/aep-overview.mdx).

Additional resources:

- [Setup AEP fee router](/launch-arbitrum-chain/chain-config/costs/aep-router-contracts.mdx)
- [Calculate AEP fees](/launch-arbitrum-chain/chain-config/costs/calculate-aep-fees.mdx)
- [Reporting on AEP fees](/launch-arbitrum-chain/chain-config/costs/reporting-on-fees.mdx)
