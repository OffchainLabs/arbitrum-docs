...
1. **Calculate net revenue**: Use tools or scripts to track total fees minus settlement costs (e.g., via on-chain queries or offchain monitoring). For custom tokens, deploy a pricer contract to value fees in **ETH** equivalents.
