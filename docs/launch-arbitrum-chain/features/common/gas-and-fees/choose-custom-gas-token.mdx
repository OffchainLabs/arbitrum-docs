...
To enable this feature for your chain, see our guide on [enabling Native Mint/Burn for gas tokens](../../../configure-your-chain/common-configurations/enable-mint-burn-for-gas-token).
:::
