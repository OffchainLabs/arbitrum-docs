...
[ArbOS 51 Dia](/run-arbitrum-node/arbos-releases/arbos51) introduces the ability for native-interop tokens to be the gas token of an Arbitrum chain. This feature allows a chain owner (`ArbOwner`) to manage:
