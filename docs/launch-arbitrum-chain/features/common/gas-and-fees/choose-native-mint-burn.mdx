...
To learn how to configure this feature for your chain refer to the [Configure a native mint/burn gas token](/launch-arbitrum-chain/chain-config/costs/configure-native-mint-burn.mdx) page.
