...
- **Adding a new [precompile](/arbitrum-essentials/precompiles/reference.mdx) method**: Extend ArbSys with a "sayHi" function that activates at ArbOS v32, returning different strings pre/post-upgrade.
