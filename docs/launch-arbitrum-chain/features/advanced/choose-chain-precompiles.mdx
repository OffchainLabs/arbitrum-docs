...
- **Add new methods to an existing [precompile](/arbitrum-essentials/precompiles/reference.mdx)**: Extend a built-in precompile (e.g., `ArbSys`) with additional functions.
