...
For information on how to configure the Sequencer timing, refer to the [Sequencer Timing Adjustments configuration](/launch-arbitrum-chain/chain-configuration/sequencer/sequencer-timing-adjustments.mdx) page.
