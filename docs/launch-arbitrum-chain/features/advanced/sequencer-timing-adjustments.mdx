...
For information on how to configure the Sequencer timing, refer to the [Sequencer Timing Adjustments configuration](/launch-arbitrum-chain/chain-config/sequencer/sequencer-timing-adjustments.mdx) page.
