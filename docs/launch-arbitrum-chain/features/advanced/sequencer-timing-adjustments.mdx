...
- Parameters like `--node.delayed-sequencer.finalize-distance` (number of parent chain confirmations to wait before releasing delayed inbox messages, e.g., deposits) and related finality flags.
