...
- If enabling [Timeboost](/how-arbitrum-works/timeboost/gentle-introduction.mdx), adjust the non-express lane delay (default 200ms).
...
- Timestamp adjustment boundaries and other sequencer behaviors allow minor tweaks to prevent re-orgs if batch posting lags.
