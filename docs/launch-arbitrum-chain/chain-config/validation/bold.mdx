...
This how-to provides step-by-step instructions for <a data-quicklook-from="L2">L2</a> Arbitrum chain operators who want to enable BoLD on their chain. Familiarity with Nitro, [BoLD](/how-arbitrum-works/bold/gentle-introduction.mdx), and [chain ownership](/launch-arbitrum-chain/operate/ownership-and-access.mdx) is expected.
