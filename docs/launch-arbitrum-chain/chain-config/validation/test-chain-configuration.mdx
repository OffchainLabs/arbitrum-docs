...
On a production Arbitrum chain, an <a data-quicklook-from="assertion">assertion</a> takes about a week to confirm. That delay is the security model working as intended, but it makes integration testing impractical. This page covers how to shorten it on a chain you do not need to secure, and which parameters differ on a testnet.
...
| `--node.staker.staker-interval`               | `1m0s`   | Legacy staker | Lower it to act on stake sooner                         |
