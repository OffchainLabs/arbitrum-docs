...
3. Configure the fee token and pricer when creating the rollup
   ...
   - `STAKE_TOKEN_ADDRESS` = token used for bonding (see [BoLD docs](/launch-arbitrum-chain/chain-config/validation/bold.mdx#use-of-your-projects-native-token-as-the-bonding-asset-to-secure-the-chain) for more details)
