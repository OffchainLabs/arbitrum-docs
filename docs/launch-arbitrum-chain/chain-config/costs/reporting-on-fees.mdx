...
1. **L1 Base Fee**: Refunds [Batch Poster](/how-arbitrum-works/deep-dives/assertions.mdx) for <a data-quicklook-from="parent-chain">parent chain</a> posting costs
...
1. [ArbOS](/how-arbitrum-works/deep-dives/arbos.mdx) consumes batch posting reports
