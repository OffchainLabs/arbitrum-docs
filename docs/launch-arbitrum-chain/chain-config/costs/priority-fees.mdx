...
Without Step 2, the sequencer continues to use its existing ordering rules—[Timeboost](/how-arbitrum-works/timeboost/gentle-introduction.mdx), if enabled, or otherwise first-come, first-served—regardless of the transaction's priority fee.
