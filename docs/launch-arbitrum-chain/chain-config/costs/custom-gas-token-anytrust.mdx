...
After deploying the chain, you must reset the base fees of the parent chain by calling the following functions in the [`ArbOwner`](/arbitrum-essentials/precompiles/reference.mdx#arbowner) precompile:
