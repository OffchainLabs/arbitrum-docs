...
You can find the latest recommended version of Nitro on the [Run a full node](/run-arbitrum-node/02-run-full-node.mdx#recommended-nitro-version) page.
