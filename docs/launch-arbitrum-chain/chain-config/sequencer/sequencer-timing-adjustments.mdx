...
| Delayed sequencer full finality                                                      | Node (`node.delayed-sequencer`)                     | `false`                                                                                       | CLI: `--node.delayed-sequencer.require-full-finality=true`                                                                                                            | Wait for full finality before sequencing delayed messages. Increases safety against re-orgs at the cost of higher deposit latency.                     |
