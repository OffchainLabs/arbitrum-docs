...
Compliance Filtering is disabled by default. Chain owners must explicitly configure and enable each component. <a data-quicklook-from="activation">Activation</a> after chain deployment may require an ArbOS upgrade.
