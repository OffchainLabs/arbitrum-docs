...
This page explains what the operational <a data-quicklook-from="sequencer">sequencer</a> flags do and what changes when you set them. For the complete list of every Nitro flag, see the [CLI flags reference](/run-arbitrum-node/reference/cli-flags-reference.mdx). For failure diagnosis, see [Sequencer troubleshooting](/launch-arbitrum-chain/operate/sequencer-troubleshooting.mdx).
