...
- The latest Nitro docker image: `@@latestNitroNodeImage=offchainlabs/nitro-node:v3.11.4-7d5ac27@@`
...
@@latestNitroNodeImage=offchainlabs/nitro-node:v3.11.4-7d5ac27@@ keygen --dir /home/user/bls_keys
```
...
services:
  das-server:
    image: @@latestNitroNodeImage=offchainlabs/nitro-node:v3.11.4-7d5ac27@@
...
@@latestNitroNodeImage=offchainlabs/nitro-node:v3.11.4-7d5ac27@@ keygen --dir /home/user/ecdsa_keys --ecdsa
```
