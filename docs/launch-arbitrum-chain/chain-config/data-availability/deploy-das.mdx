...
- The latest Nitro docker image: `@@latestNitroNodeImage=offchainlabs/nitro-node:v3.9.9-6b0af88@@`
...
@@latestNitroNodeImage=offchainlabs/nitro-node:v3.9.9-6b0af88@@ keygen --dir /data/keys
```
...
import S3Parameters from '../../02-configure-your-chain/common/data-availability/data-availability-committees/partials/parameters/_s3-parameters.mdx';
import LocalFilesParameters from '../../02-configure-your-chain/common/data-availability/data-availability-committees/partials/parameters/_local-files-parameters.mdx';
import GoogleCloudStorageParameters from '../../02-configure-your-chain/common/data-availability/data-availability-committees/partials/parameters/_gcs-parameters.mdx';
import LocalBadgerDBParameters from '../../02-configure-your-chain/common/data-availability/data-availability-committees/partials/parameters/_local-badger-db-parameters.mdx';
...
template:
    ...
    - command:
        ...
        image: @@latestNitroNodeImage=offchainlabs/nitro-node:v3.9.9-6b0af88@@
...
```shell
docker run --rm -it -v /some/local/dir:/home/user/data --entrypoint datool @@latestNitroNodeImage=offchainlabs/nitro-node:v3.9.9-6b0af88@@ keygen --dir /home/user/data/keys --ecdsa
```
...
```shell
docker run --rm -it -v /some/local/dir:/home/user/data --network="host" --entrypoint datool @@latestNitroNodeImage=offchainlabs/nitro-node:v3.9.9-6b0af88@@ client rpc store --server-url http://localhost:9876 --message "Hello world" --signing-key /home/user/data/keys/ecdsa
```
...
```shell
docker run --rm -it --network="host" --entrypoint datool @@latestNitroNodeImage=offchainlabs/nitro-node:v3.9.9-6b0af88@@ client rest getbyhash --server-url http://localhost:9877 --data-hash 0xDataHash
```
...
Find information about how to setup a mirror DAS in [How to deploy a mirror DAS](/launch-arbitrum-chain/chain-config/data-availability/deploy-mirror-das.mdx).
...
import DASOptionalParameters from '../../02-configure-your-chain/common/data-availability/data-availability-committees/partials/_das-optional-parameters.mdx';
import DASMetrics from '../../02-configure-your-chain/common/data-availability/data-availability-committees/partials/_das-metrics.mdx';
