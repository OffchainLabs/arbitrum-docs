...
```shell
docker run -v $(pwd):/data/keyset --entrypoint anytrusttool @@latestNitroNodeImage=offchainlabs/nitro-node:v3.11.4-7d5ac27@@ dumpkeyset --conf.file /data/keyset/keyset-info.json
```
