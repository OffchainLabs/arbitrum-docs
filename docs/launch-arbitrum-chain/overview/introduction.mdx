...
Keep data off the public L1 with an <a data-quicklook-from="data-availability-committee-dac">AnyTrust data availability committee</a>.
...
Whether Rollup, AnyTrust, <a data-quicklook-from="alt-da">Alt-DA</a>—choose the one that fits your case to trade off cost against transparency and resilience.
...
How quickly transactions become final and withdrawable. Set the **<a data-quicklook-from="delayed-inbox">delayed inbox</a> finality**, the **<a data-quicklook-from="challenge-period">challenge period</a>**, and **fast withdrawals** to balance settlement speed against reorg and security risk.
