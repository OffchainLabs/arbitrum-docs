...
- **Orbit-Specific**: Storage requirements are similar. If running AnyTrust, you will need to run your own DAS or use a third-party DA service provider.
...
| **Storage**   | 400 GB SSD                  | 1 TB+                | Includes chain data                                                           |
