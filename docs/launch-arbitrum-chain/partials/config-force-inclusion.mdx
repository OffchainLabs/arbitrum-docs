Force inclusion in Arbitrum refers to a mechanism that allows users to bypass the Sequencer by submitting transactions directly to the Delayed Inbox contract on Ethereum. After a waiting period, typically around 24 hours, it is possible to force the transaction for inclusion on the Arbitrum chain. This mechanism is designed primarily as a safeguard for rare scenarios, such as sequencer downtime or potential censorship.
