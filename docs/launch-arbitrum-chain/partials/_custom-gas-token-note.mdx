...
To enable this feature for your chain, see our guide on [enabling native mint/burn for gas tokens](/launch-arbitrum-chain/chain-config/costs/configure-native-mint-burn).
