...
To learn how the <a data-quicklook-from="batch-poster">batch-poster</a> role relates to the other Nitro node roles, including its wallet requirements and the safety rules for running redundant posters, see [How to assign roles to a Nitro node](/run-arbitrum-node/operation/assign-node-roles.mdx).
...
| ----------------------------------------------------- | ------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `--node.batch-poster.enable`                          | false         | Enables posting batches to <a data-quicklook-from="L1">L1</a>                                                                                                                                                              |
