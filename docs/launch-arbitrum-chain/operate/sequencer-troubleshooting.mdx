...
**A related message on the same path:**
...
2. Does a sequencer hold the lockout? Read `coordinator.chosen` in Redis, or use the <a data-quicklook-from="sequencer">Sequencer</a> Coordination Manager (SQM).
