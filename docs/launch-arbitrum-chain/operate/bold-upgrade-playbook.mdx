...
If your chain owner is a single key that can send the upgrade <a data-quicklook-from="transaction">transaction</a> immediately, you do not need this guide—follow the base steps instead.
...
The base guide therefore recommends stopping all <a data-quicklook-from="validator">validators</a> at Step 4 to prevent a new <a data-quicklook-from="confirmation">confirmation</a> from blocking Step 5.
