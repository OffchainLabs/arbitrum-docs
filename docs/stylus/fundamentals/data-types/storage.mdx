...
<ImageZoom
  src="/img/stylus-storage-types-hierarchy.png"
  alt="Storage type hierarchy diagram showing primitives, collections, and custom struct options"
  className="img-600px"
>
  Storage type hierarchy showing primitives, collections, and custom struct options.
</ImageZoom>
