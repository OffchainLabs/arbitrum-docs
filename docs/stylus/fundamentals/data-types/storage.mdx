...
_Figure 3: Storage type hierarchy showing primitives, collections, and custom struct options._
...
flowchart TB
    ...
    Mapping["Mapping[key]"] -->|"hash(key + 2)"| Slot3

    style Slot0 fill:#E3F2FD
    style Slot1 fill:#FFF3E0
    style Slot2 fill:#F3E5F5
    style Slot3 fill:#E8F5E9
```

_Figure: Storage slot layout showing how variables are packed into 32-byte slots and how mapping values are computed using keccak256 hashing._
