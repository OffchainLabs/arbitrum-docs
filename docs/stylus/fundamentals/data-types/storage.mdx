...
<ImageZoom
  src="/img/stylus-storage-slots.png"
  alt="Storage slot layout diagram showing how variables are packed into 32-byte slots and how mapping values are computed using keccak256 hashing"
  className="img-600px"
>
  Storage slot layout showing how variables are packed into 32-byte slots and how mapping values are
