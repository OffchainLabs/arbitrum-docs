...
**Note:** See [Block Numbers and Time](/build-decentralized-apps/arbitrum-vs-ethereum/02-block-numbers-and-time) for more information on how this value is determined on Arbitrum.
