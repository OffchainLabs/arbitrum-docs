...
**Note:** See [Block Numbers and Time](/arbitrum-essentials/arbitrum-vs-ethereum/block-numbers-and-time) for more information on how this value is determined on Arbitrum.
