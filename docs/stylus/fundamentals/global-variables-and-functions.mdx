...
- For L1-to-L2 retryable ticket transactions, the top-level sender's address will be [aliased](/how-arbitrum-works/deep-dives/l1-to-l2-messaging#address-aliasing)
...
**Note:** See [Block Numbers and Time](/build-decentralized-apps/arbitrum-vs-ethereum/block-numbers-and-time) for more information on how this value is determined on Arbitrum.
