...
| `require(condition, "error")` | `Result<T, E>` + `?`        | [Error handling](/stylus/fundamentals/contracts#error-handling)         |
| `msg.sender`                  | `self.vm().msg_sender()`    | [Global functions](/stylus/fundamentals/global-variables-and-functions) |
| `constructor`                 | `#[constructor]` method     | [Contracts](/stylus/fundamentals/contracts)                             |
| Events                        | `self.vm().log(Event{})`    | [Global functions](/stylus/fundamentals/global-variables-and-functions) |
