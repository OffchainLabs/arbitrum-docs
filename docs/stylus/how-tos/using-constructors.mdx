...
<VanillaAdmonition type="info" title="Constructors and composition">
  Stylus uses [trait-based composition](./trait-based-composition) instead of traditional inheritance. When building contracts that compose multiple traits, constructors help initialize all components properly. See the [Constructor with trait-based composition](#constructor-with-trait-based-composition) section for examples.
</VanillaAdmonition>
