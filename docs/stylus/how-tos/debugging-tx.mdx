...
description: 'This how-to explains how to debug Stylus transactions using cargo stylus replay, usertrace, and cross-environment tools.'
author: mahsamoosavi
sme: mahsamoosavi
...
- [StylusDB](https://github.com/walnuthq/stylusdb): It provides visual function call trees and step-through debugging for Rust-based smart contracts.
- [SolDB](https://github.com/walnuthq/soldb): It enables developers to step through Solidity execution, inspect variables, and debug failing transactions.
...
For detailed cross-environment debugging documentation, see:

- [StylusDB Guide](https://github.com/aspect-build/stylus-sdk-rs/blob/main/cargo-stylus/docs/StylusDebugger.md)
