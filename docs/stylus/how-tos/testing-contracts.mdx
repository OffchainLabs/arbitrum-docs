...
<CustomDetails summary="Advanced TestVM Configuration Example">
...
fn test_advanced_testvm_configuration() {
    ...
    let event_signature: B256 =
        hex!("8f4636f285d71991c0de7599dcc0a626406f96e7354409c85f6e0784fa7d2f7e").into();
