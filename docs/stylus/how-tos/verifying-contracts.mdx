...
<ImageZoom src="/img/stylus/verify-and-publish.webp" alt="Verify and Publish link on Arbiscan" />
...
<ImageZoom
  src="/img/stylus/compiler-type-stylus-rust.webp"
  alt="Select Stylus Rust compiler type"
/>

3. **cargo-stylus version**: Select the version you used for deployment (must be ≥ 0.5.0)

<ImageZoom src="/img/stylus/cargo-stylus-version.webp" alt="Select cargo-stylus version" />
...
- [Explore CLI tools](../using-cli.mdx)
