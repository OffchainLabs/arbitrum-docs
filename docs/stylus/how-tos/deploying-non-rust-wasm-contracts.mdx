...
Deploy it with the Stylus CLI tool. This example deploys to Arbitrum Sepolia; you can also target a [local Stylus devnode](/build-decentralized-apps/run-local-full-chain-simulation) at `http://localhost:8547`:
