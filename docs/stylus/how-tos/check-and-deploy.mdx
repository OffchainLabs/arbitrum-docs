...
- [Optimizing WASM size](https://github.com/OffchainLabs/cargo-stylus/blob/main/OPTIMIZING_BINARIES.md)
- [Valid WASM requirements](https://github.com/OffchainLabs/cargo-stylus/blob/main/VALID_WASM.md)
