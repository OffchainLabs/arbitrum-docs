...
Add WASM ([WebAssembly](https://webassembly.org/)) as a build target for the specific Rust toolchain you are using. The below example sets your default Rust toolchain to 1.91 or newer as well as adding the WASM build target:
...
### [cargo-stylus repository](https://github.com/OffchainLabs/stylus-sdk-rs/tree/main/cargo-stylus): consult cargo stylus' source code.
