...
2. **Activation**: Converts the bytecode into an executable Stylus program by registering it with the [ArbWasm precompile](/arbitrum-essentials/precompiles/reference#common-precompiles)
...
After activation, contracts can be [cached](../how-tos/caching-contracts) for cheaper calls:
