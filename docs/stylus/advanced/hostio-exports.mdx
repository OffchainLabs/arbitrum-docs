...
:::info
See [Arbitrum block numbers and time](/build-decentralized-apps/arbitrum-vs-ethereum/02-block-numbers-and-time) for more information on how block numbers work on Arbitrum chains.
:::
...
- [Arbitrum block numbers and time](/build-decentralized-apps/arbitrum-vs-ethereum/02-block-numbers-and-time)
