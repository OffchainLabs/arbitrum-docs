...
Below you can find faucets for obtaining testnet `ETH`. If using a faucet on Ethereum Sepolia or Arbitrum Sepolia, your testnet `ETH` can be bridged to the
Stylus testnet on the [Arbitrum Bridge](https://bridge.arbitrum.io/).
