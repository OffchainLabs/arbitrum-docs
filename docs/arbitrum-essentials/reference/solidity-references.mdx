...
Solidity is the dominant high-level, statically typed, object-oriented language for writing <a data-quicklook-from="smart-contract">smart contracts</a> that run on the Ethereum Virtual Machine (EVM) and EVM-compatible chains (including <a data-quicklook-from="layer-2-l2">Layer 2s</a> like <a data-quicklook-from="arbitrum">Arbitrum</a>). It powers the vast majority of DeFi, NFTs, DAOs, and other onchain applications.
