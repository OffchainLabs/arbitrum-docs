...
A teleport deposit creates a chain of [retryable tickets](/arbitrum-essentials/bridging/cross-chain-messaging.mdx) that propagate your tokens through each layer:
...
Retryable tickets expire after their lifetime (default: 7 days). If a retryable expired, the tokens are sitting on L2 rather than L3. You can manually bridge them from L2 to L3 using the standard [deposit flow](/arbitrum-essentials/bridging/deposit/tokens.mdx).
...
- [Deposit tokens (L1 to L2)](/arbitrum-essentials/bridging/deposit/tokens.mdx)
- [Withdraw tokens (L2 to L1)](/arbitrum-essentials/bridging/withdraw/tokens.mdx)
- [Cross-chain messaging overview](/arbitrum-essentials/bridging/cross-chain-messaging.mdx)
