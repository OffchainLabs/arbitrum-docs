...
| `replay`    | Replays state transitions for fraud proof verification. Compiled to WASM for onchain dispute resolution.          |
...
| `blobtool`       | Testing utility for beacon chain blob endpoints. Reads and verifies EIP-4844 blobs from a beacon node.                                                         |
