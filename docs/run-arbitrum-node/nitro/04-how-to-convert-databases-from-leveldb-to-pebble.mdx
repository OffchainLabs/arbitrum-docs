...
For background on how the database backend interacts with Nitro's caches and memory usage, see [Nitro memory management](/run-arbitrum-node/nitro/05-nitro-memory-management.mdx).
