...
<VanillaAdmonition type="tip">
  Because environment variables have the highest precedence, they are the safest way to inject
  secrets or per-environment overrides without modifying config files.
</VanillaAdmonition>
