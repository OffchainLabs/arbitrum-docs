...
This page assumes that you've completed the steps from the [Start here](/run-arbitrum-node/start-here.mdx) page. If you haven't, you'll need to do so, as it gathers RPC endpoints, Nitro version, database snapshots, and other information required to run the node.
