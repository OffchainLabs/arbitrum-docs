...
:::caution
[EIP-2537](https://eips.ethereum.org/EIPS/eip-2537) is not enabled in ArbOS 40 Callisto. This means that the precompiled contracts for certain operations on the BLS12-381 elliptic curve are not supported. However, these precopmiles are planned to be proposed in a future ArbOS release.
:::
...
:::caution
This EIP and its specified precompiles are part of ArbOS 40 Callisto but are _not_ enabled. The enabling of these precompiles will be proposed in a future ArbOS release.
:::
