...
:::caution
This EIP and its specified precompiles are part of ArbOS 40 Callisto but are *not* enabled. The enabling of these precompiles will be proposed in a future ArbOS release.
:::
