...
This page is intended for all Arbitrum node operators and Arbitrum chain owners chains. This page summarizes the changes brought by <a data-quicklook-from="arbos">ArbOS</a> 51 "Dia", and what you should do to ensure a seamless upgrade.
