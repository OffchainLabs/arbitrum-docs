...
### Optional priority fee collection

*@Vanessa Bridge to update*

ArbOS 61 Elara introduces a way to collect tips as priority fees on the Arbitrum chain. This change is implemented using the `maxPriorityFeePerGas` Field in standard EIP-1559 type 2 transactions. 

Arbitrum One and Nova do not currently support the collection of priority fees, and the origin address of the transaction will be refunded at the end of execution by the sequencer.

[Check out these docs for more details.](https://app.notion.com/p/Priority-fees-collection-ArbOS-61-34b01a3f59f8814ea643e85330c90c56?pvs=21)
