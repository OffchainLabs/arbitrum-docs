...
This page summarize what changes brought by ArbOS 50 Dia, and what you should do to ensure a seamless upgrade.
...
Nitro `v3.8.0` will be the minimum version for any chain with Fusaka parent
