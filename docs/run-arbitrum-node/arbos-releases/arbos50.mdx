...
### Special notes about Ethereum’s PeerDAS ([EIP-7594](https://eips.ethereum.org/EIPS/eip-7594)) for Nitro operators

:::caution

Action Required: Orbit Chains must upgrade to Nitro v3.8.0 before Sepolia/Mainnet Fusaka. Read more [here](#)

:::

:::caution

Breaking Change Notice: RPC nodes, Arbitrum One / Nova node operators, Orbit Chain node operators, will need to make sure they connect to a L1 Ethereum Beacon Chain node that has historical blob data in order for the Nitro node software to function properly. Read more [here](https://www.notion.so/arbitrum/EXT-Comms-Breaking-Change-Notice-PeerDAS-Upgrade-in-Fusaka-28401a3f59f880d68e83ce2779b79ce3#28401a3f59f880d68e83ce2779b79ce3)
