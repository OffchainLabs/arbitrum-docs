...
- Running [nitro-contracts v3.1.0](https://github.com/OffchainLabs/nitro-contracts/releases/tag/v3.1.0) or higher
  ...
  - If you want to enable [Native Token Mint/Burn capabilities](#native-token-mint-and-burn) for your chain, use [nitro-contracts v3.1.1](https://github.com/OffchainLabs/nitro-contracts/releases/tag/v3.1.1).
...
If you want to enable Native Token Mint/Burn capabilities for your chain, use [nitro-contracts v3.1.1](https://github.com/OffchainLabs/nitro-contracts/releases/tag/v3.1.1) instead.
