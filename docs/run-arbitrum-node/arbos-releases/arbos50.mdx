...
While ArbOS 50 Dia will be compatible with both `nitro-contracts 3.x` and `nitro-contracts 2.1.3`, only chains that have Arbitrum BoLD enabled can use `nitro-contracts 3.x`. This requirement means that if your chain has not yet upgraded to use BoLD, please only use `nitro-contracts 2.1.3` for your ArbOS 50 Dia upgrade.
