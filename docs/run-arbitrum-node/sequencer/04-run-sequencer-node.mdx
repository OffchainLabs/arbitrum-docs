...
We also provide a guide for running a high-availability sequencer node for an Arbitrum chain. You can find it [here](./05-high-availability-sequencer-docs.mdx).
:::
...
Latest Docker image: <code>@@latestNitroNodeImage=offchainlabs/nitro-node:v3.8.0-62c0aa7@@</code>
