...
- Before starting the Sequencer Coordinator Manager, please read and follow the commands in Step 4 - Step 7 of [Build Nitro's binaries natively](../build-nitro-locally.mdx#build-nitros-binaries-natively) to install the necessary dependencies.
