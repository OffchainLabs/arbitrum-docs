...
| -------------------------------------------------------------------------- | ------------------------------------------ | -------------------- |
| [Nitro 3.11.x](https://github.com/OffchainLabs/nitro/releases/tag/v3.11.2) | 30 calendar days after 3.11.x is released. | Docker               |
| [Nitro 3.11.1](https://github.com/OffchainLabs/nitro/releases/tag/v3.11.0) | July 29, 2026                              | Docker               |
