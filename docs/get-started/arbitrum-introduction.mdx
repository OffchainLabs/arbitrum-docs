...
You can also create your own Arbitrum chain with custom gas tokens. For example, you could create a chain that uses USDC for gas. Arbitrum chains are endlessly customizable beyond the gas token. You can learn more about [Arbitrum chains](/launch-arbitrum-chain/01-a-gentle-introduction.mdx).
