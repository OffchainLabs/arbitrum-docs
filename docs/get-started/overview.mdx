...
| [Configure a Data Availability Committee](/launch-arbitrum-chain/features/data-availability/dac-get-started.mdx) | For Data Availability Committee members and Arbitrum chain operators who want to run a Data Availability Server. |
...
| Resource                                                                                | Description                                                                          |
| --------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------ |
| [Arbitrum chains gentle introduction](/launch-arbitrum-chain/overview/introduction.mdx) | For readers who want to understand Arbitrum chain's value proposition and use cases. |
