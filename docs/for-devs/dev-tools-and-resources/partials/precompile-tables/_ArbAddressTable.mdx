<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <a href="https://github.com/OffchainLabs/nitro/blob/v3.9.9/precompiles/ArbAddressTable.go#L17" target="_blank">
          Implementation
        </a>
      </td>
    ...
    <tr>
      ...
      <td>
        <a href="https://github.com/OffchainLabs/nitro/blob/v3.9.9/precompiles/ArbAddressTable.go#L22" target="_blank">
          Implementation
        </a>
      </td>
    ...
    <tr>
      ...
      <td>
        <a href="https://github.com/OffchainLabs/nitro/blob/v3.9.9/precompiles/ArbAddressTable.go#L27" target="_blank">
          Implementation
        </a>
      </td>
    ...
    <tr>
      ...
      <td>
        <a href="https://github.com/OffchainLabs/nitro/blob/v3.9.9/precompiles/ArbAddressTable.go#L40" target="_blank">
          Implementation
        </a>
      </td>
    ...
    <tr>
      ...
      <td>
        <a href="https://github.com/OffchainLabs/nitro/blob/v3.9.9/precompiles/ArbAddressTable.go#L52" target="_blank">
          Implementation
        </a>
      </td>
    ...
    <tr>
      ...
      <td>
        <a href="https://github.com/OffchainLabs/nitro/blob/v3.9.9/precompiles/ArbAddressTable.go#L67" target="_blank">
          Implementation
        </a>
      </td>
    ...
    <tr>
      ...
      <td>
        <a href="https://github.com/OffchainLabs/nitro/blob/v3.9.9/precompiles/ArbAddressTable.go#L73" target="_blank">
          Implementation
        </a>
      </td>
