<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <a href="https://github.com/OffchainLabs/nitro/blob/v3.9.9/precompiles/ArbAggregator.go#L25" target="_blank">
          Implementation
        </a>
      </td>
    ...
    <tr>
      ...
      <td>
        <a href="https://github.com/OffchainLabs/nitro/blob/v3.9.9/precompiles/ArbAggregator.go#L32" target="_blank">
          Implementation
        </a>
      </td>
      <td>Deprecated: Do not use this method.</td>
    ...
    <tr>
      ...
      <td>
        <a href="https://github.com/OffchainLabs/nitro/blob/v3.9.9/precompiles/ArbAggregator.go#L37" target="_blank">
          Implementation
        </a>
      </td>
    ...
    <tr>
      ...
      <td>
        <a href="https://github.com/OffchainLabs/nitro/blob/v3.9.9/precompiles/ArbAggregator.go#L42" target="_blank">
          Implementation
        </a>
      </td>
    ...
    <tr>
      ...
      <td>
        <a href="https://github.com/OffchainLabs/nitro/blob/v3.9.9/precompiles/ArbAggregator.go#L65" target="_blank">
          Implementation
        </a>
      </td>
    ...
    <tr>
      ...
      <td>
        <a href="https://github.com/OffchainLabs/nitro/blob/v3.9.9/precompiles/ArbAggregator.go#L74" target="_blank">
          Implementation
        </a>
      </td>
    ...
    <tr>
      ...
      <td>
        <a href="https://github.com/OffchainLabs/nitro/blob/v3.9.9/precompiles/ArbAggregator.go#L98" target="_blank">
          Implementation
        </a>
      </td>
    ...
    <tr>
      ...
      <td>
        <a href="https://github.com/OffchainLabs/nitro/blob/v3.9.9/precompiles/ArbAggregator.go#L106" target="_blank">
          Implementation
        </a>
      </td>
