...
[Openfort](https://openfort.io) is an open-source wallet infrastructure build with authentication and payments. Openfort has developed SDK that vertically integrate the creation of wallet and the account abstraction technology all in one.  

### [Embedded Wallet](https://www.openfort.io/embedded-wallet)

Build for React, React Native, Swift and Unity SDK. it enables app developers to onbaord user and generate wallets for them. Features include:
...
If you're building your own Orbit chain and are thinking about owning the wallet, connect with us. Global wallet is designed for you to have an universal sign-on across all the apps in your ecosystem. 
...
For a more detailed tutorial, please refer to the [Quickstart Guide](https://www.openfort.io/docs/).
