...
- **Developer-Centric**: Venly's intuitive tools and resources are designed to help developers to succeed.
...
Venly supports the Arbitrum chain on its Wallet API which allows you to create wallets on the Arbitrum chain. You can send and receive funds to/from Arbitrum wallets directly through the Wallet API, enabling integration with applications using the Arbitrum blockchain.
