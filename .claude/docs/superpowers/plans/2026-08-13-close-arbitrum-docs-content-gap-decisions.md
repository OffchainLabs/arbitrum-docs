...
`upstream-drift.mjs` pairs pages by normalized _slug_. Several known migration renames change the filename itself, so slug matching cannot pair them:
