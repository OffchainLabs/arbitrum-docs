...
3. If you need **both** post-nitro and pre-nitro archive requests, you should run **both** an archive Nitro node **and** an archive classic node, there we  explain how to do this.
