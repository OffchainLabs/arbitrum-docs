...
- Arbitrum Classic Database Snapshot
  
  - Use the parameter `--init.url="https://snapshot.arbitrum.io/mainnet/db.tar"` on first startup to initialize Classic database
