...
3. Both post-nitro and pre-nitro archive requests needs, the you should run not only archive nitro node but also archive classic node, this docs will tell you how to do this.
