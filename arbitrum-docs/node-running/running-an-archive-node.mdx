...
| -------------------------------------------------------------------------------- | --------------------------------------------------------- | ---------------------------------------------------------- |
| Run an **archive node** for **Nitro Goerli Rollup Testnet** or **Arbitrum Nova** | Full node (Nitro)                                         | [How to run a full node](./running-a-node.md)              |
| Access the **Arbitrum network** but you don’t want to run your own node          | Fully managed by third-parties, exposed via RPC endpoints | [Node Providers](./node-providers.mdx)                     |
| Send **post-Nitro** archive requests                                             | Full node (Nitro)                                         | [How to run a full node](./running-a-node.md)              |
| Send **pre-Nitro** archive requests                                              | Full node (Classic)                                       | [How to run a classic node](./running-a-classic-node.mdx)  |
