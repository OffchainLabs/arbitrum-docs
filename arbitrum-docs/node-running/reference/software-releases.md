...
- For validators of Arbitrum chains that settle to Etheruem, upgrading to the Atlas ArbOS release will require access to L1 Ethereum beacon chain endpoints to retrieve blob data for validating L2 state. [Please visit this page to view a list of beacon chain RPC providers](./l1-ethereum-rpc-providers).
