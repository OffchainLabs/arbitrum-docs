...
- Addition of the [`L1RewardReceipient`](/build-decentralized-apps/precompiles/reference##arbgasinfo) and [`L1RewardRate`](/build-decentralized-apps/precompiles/reference##arbgasinfo) precompile methods to view L1 pricing parameters and make it easier to view the current chain configuration.
