...
Note: This guide is based on [debian-11.6.0](https://cdimage.debian.org/debian-cd/current/arm64/iso-cd/debian-11.6.0-arm64-netinst.iso)
### 0. Setup Prerequisites
  ```bash
  apt install git curl build-essential cmake npm golang clang make
