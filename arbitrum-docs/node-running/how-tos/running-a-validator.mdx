...
- Here is an example of how to run a allowlisted defensive validator for Arbitrum One:
  ```shell
...
- To verify validator is working, this log line shows the wallet is setup correctly:
  ...
  ```
  - `whitelisted` should be `true` after your wallet has been added to allowlist
