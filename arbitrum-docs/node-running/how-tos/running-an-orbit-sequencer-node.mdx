...
Latest Docker Image: <code>@@latestNitroNodeImage=offchainlabs/nitro-node:v3.5.1-8f247fd@@</code>
...
import OptionalOrbitSequencerCompatibleCLIFlagsPartial from '../../partials/arbitrum-docs/partials/_optional-orbit-sequencer-compatible-cli-partial.mdx';
