...
This guide follows the process to setup a regular nitro local dev node without Stylus support. If you want to have Stylus support for your local development environment, [check out this guide](/stylus/reference/local-stylus-dev-node.mdx).
