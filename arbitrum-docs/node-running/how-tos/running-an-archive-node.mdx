...
5. **Database snapshots:**
   ...
   - Arbitrum One Classic database snapshot
     - Download the latest Arbitrum One Classic database snapshot `"https://snapshot.arbitrum.foundation/arb1/classic-archive.tar"` and put it to the mounted point directory.
