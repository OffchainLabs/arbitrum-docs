...
author: jose-franco
sidebar_label: Deploy a Data Availability Server (DAS)
sidebar_position: 2
content-type: how-to
---
...
Here if we set `<0xDataHash>` as `0x052cca0e379137c975c966bcc69ac8237ac38dc1fcf21ac9a6524c87a2aab423` (this hash is what we got from the last setp) as an example, then the result should be: `Message: Hello world`
