---
title: 'How to configure a Data Availability Committee: deploy a Data Availability Server (DAS)'
description: This how-to will help you deploy a Data Availability Server (DAS)
author: jose-franco
sidebar_label: Deploy a DAS
sidebar_position: 2
content-type: how-to
---
...
In this how-to you'll learn how to deploy a Data Availability Server (DAS) and enable an RPC interface to store batches received from the sequencer, and a REST interface to respond to requests of stored information. For more information related to configuring a DAC, please see the [Introduction](./introduction.mdx).
...
If there are other storage backends you'd like us to support you can send us a message on [Discord](https://discord.gg/arbitrum), or contribute directly to the [nitro repository](https://github.com/OffchainLabs/nitro/).
...
We now start the process of deploying the DAS. Remember that you can reach out to us on [Discord](https://discord.gg/arbitrum) if you are having trouble following this process.
