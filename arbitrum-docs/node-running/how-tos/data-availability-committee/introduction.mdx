...
Before following the guides in this section, you should be familiarized with how the AnyTrust protocol works and what's the role of the DAC in the protocol. You can find more information about the AnyTrust protocol in [Inside AnyTrust](/inside-anytrust.mdx).
...
- [Deploy a mirror DAS](./deploy-a-mirror-das.mdx) if your main DAS doesn't have the REST interface enabled. Send the following information to the chain owner:
  - The https URL for the REST endpoint (e.g. das.your-chain.io/rest)
...
- Ensure that at least one DAS is running as an [archive DAS](./deploy-a-mirror-das.mdx#archive-da-servers-for-mirror-das)
