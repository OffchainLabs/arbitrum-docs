...
author: jose-franco
sidebar_label: Deploy a mirror Data Availability Server (DAS)
sidebar_position: 3
content-type: how-to
---
...
In this how-to, you'll learn how to configure a mirror Data Availability Server (DAS) that serves `GET` requests for stored batches of information through a REST HTTP interface. For a refresher on DACs, refer to the _[Introduction](./introduction.mdx)_.
