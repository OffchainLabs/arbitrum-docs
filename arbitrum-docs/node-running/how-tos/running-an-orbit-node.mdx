...
[Public Arbitrum RPC endpoints](/node-running/node-providers.mdx/#arbitrum-public-rpc-endpoints) rate-limit connections. To avoid hitting a bottleneck, you can  run a local node for the parent chain or rely on third-party RPC providers.
