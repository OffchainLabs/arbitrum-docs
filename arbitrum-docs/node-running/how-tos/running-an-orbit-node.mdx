...
This guide provides a step-by-step process for deploying and operating an Orbit node on your local machine. To initiate an Orbit node, it's essential to first deploy the core contracts of the Orbit chain. Additionally, you must supply a `nodeConfig.json` file, which includes crucial configurations required for the Orbit chain's operation. An example of the node configuration file is available at the conclusion of this section. For more information about orbit chain deployment please check our [Launch Your Own Chain](../../launch-orbit-chain/orbit-gentle-introduction.md) part of our docs.
