...
| Arbitrum Sepolia (Testnet) | https://sepolia-rollup.arbitrum.io/rpc | 421614   | https://sepolia-explorer.arbitrum.io/ | Sepolia       | Nitro      |                                      | https://sepolia-rollup-sequencer.arbitrum.io/rpc |
...
⚠️ Important note: Ethereum Goerli will be deprecated in Q1 2023 but will be supported until Q4 2023. Once Arbitrum Sepolia becomes publicly available, we will phase out the usage of Arbitrum Goerli. The support for Arbitrum Sepolia will cease prior to the conclusion of Goerli Mainnet assistance.
