...
[DIA](https://www.diadata.org/) provides customizable oracles tailored to individual dApp requirements, with flexibility in data sources, filters, pricing, and update methods. Drawing trade data from 80+ sources including CEXs, DEXs, and NFT marketplaces, DIA ensures transparency and control. Their suite includes price feeds for 20,000+ cryptocurrencies, NFTs, LSTs, and more.
...
DIA token price feeds provide smart contracts with real-time price information for [3,000+ cryptocurrencies](https://diadata.org/app/price), sourced transparently from [80+ trusted, high-volume DEXs and CEXs](https://diadata.org/app/source/defi).
