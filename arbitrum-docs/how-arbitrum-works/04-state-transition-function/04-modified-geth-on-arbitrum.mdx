...
| [`ArbitrumRetryTx`](#arbitrumretrytx)                     | A retryable redeem attempt                       | [`EndTxHook`](#endtxhook)     | Child chain |
...
Introduces [ArbOS](/how-arbitrum-works/state-transition-function/05-arbos.mdx), converting what would otherwise be a vanilla parent chain into a child chain Arbitrum rollup.
