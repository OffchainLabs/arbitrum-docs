...
- **Execution in a WASM runtime**: Stylus transactions execute in <a data-quicklook-from="arbos">ArbOS's</a> WASM runtime, rather than the EVM, enabling faster execution and more efficient computation.
