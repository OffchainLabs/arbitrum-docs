...
- **Fraud-proof system**: If an incorrect assertion is detected, validators can challenge it and trigger an interactive fraud-proof.
...
- **Inbox message consumption**: A record of processed messages from the parent chain.
