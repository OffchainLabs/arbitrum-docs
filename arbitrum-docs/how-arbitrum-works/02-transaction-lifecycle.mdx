...
import TransactionLifecycle from '../bold/assets/transaction-lifecycle.svg';
...
<ImageZoom alt="Transaction lifecycle" sources={{ TransactionLifecycle }} className="500px-img" />
