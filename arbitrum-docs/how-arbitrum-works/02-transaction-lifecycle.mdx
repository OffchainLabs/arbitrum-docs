...
<ImageZoom
  src={require('../bold/assets/transaction-lifecycle.svg').default}
...
<ImageZoom
  src={require('../assets/submit-tx-to-sequencer.svg').default}
...
<ImageZoom
  src={require('../assets/bypassing-the-sequencer.svg').default}
