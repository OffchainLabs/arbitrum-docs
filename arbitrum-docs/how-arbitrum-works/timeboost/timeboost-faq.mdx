...
Depending on which option the Arbitrum DAO chooses, the auction contract can transfer the proceeds to a designated account or burn them. As of Sept 19, 2024, the Arbitrum DAO has signaled a preference for Option 1 (collecting bids in `ETH`) in the temperature check vote on Snapshot [here](https://snapshot.org/#/arbitrumfoundation.eth/proposal/0xffe9bb38228fdaf3d121140856fd2d51c2ca7f8e0d1021c07e791cebb541129a).
