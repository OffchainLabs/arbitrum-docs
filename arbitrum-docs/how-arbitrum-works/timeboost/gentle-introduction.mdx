...
<ImageZoom
  src="/img/timeboost-centralized-timeboost-auction-workflow.jpg"
  alt="Timeboost auction workflow"
/>
...
- [Timeboost FAQ](/how-arbitrum-works/timeboost/timeboost-faq.mdx)
