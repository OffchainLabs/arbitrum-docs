...
- **New L2 to L1 event signature**: The function signature for the L2 to L1 event emitted by [ArbSys](/for-devs/dev-tools-and-resources/precompiles.mdx#arbsys) has now changed.
...
For addresses of protocol contracts, see [Smart contract addresses](/for-devs/useful-addresses.mdx).
