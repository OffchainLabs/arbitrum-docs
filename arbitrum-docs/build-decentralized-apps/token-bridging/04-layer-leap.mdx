...
Can now bridge `ETH` and `ERC-20`s from Ethereum to your Arbitrum L3 chain (Orbit) in a single click.
...
**Arbitrum L3s chains (Orbit):** Can more seamlessly onboard `ETH` and `ERC-20`s from Ethereum mainnet.

_Which Arbitrum L3s chains ( Orbit ) configurations can adopt this feature?_

**Any Arbitrum L3s chains (Orbit) on top of an Arbitrum chain** **_with ETH gas fees_** can use Layer Leap.
...
- _Future support: Layer Leap will support Arbitrum chains (Orbit) chains with custom gas tokens in a future release_

## Implementation

_How can Arbitrum chains (Orbit) adopt this feature?_
...
If you want to integrate layer leap functionality into your custom bridge UI, read the [info page on the layer leap github](https://github.com/offchainlabs/l1-l3-teleport-contracts/blob/main/docs/info.md) to learn more.
