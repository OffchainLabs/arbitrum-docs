...
This how-to is for **developers** who want to migrate existing NFT collections from Ethereum mainnet to <a data-quicklook-from="arbitrum-one">Arbitrum One</a> or <a data-quicklook-from="arbitrum-nova">Nova</a>. This applies to NFT collections that support decentralized apps (dApps) and collections that don't.

:::caution

[bridge.arbitrum.io](https://bridge.arbitrum.io/) does not support NFTs.
...
There are two main reasons to migrate your dApp's NFTs to Arbitrum:
...
Before we begin, let's align on the various types of tokens that can be used as NFTs:
...
This option is ideal if you want to migrate your NFT collection to <a data-quicklook-from="arbitrum-one">Arbitrum One</a> or <a data-quicklook-from="arbitrum-nova">Nova</a> without introducing new third-party trust assumptions. 
