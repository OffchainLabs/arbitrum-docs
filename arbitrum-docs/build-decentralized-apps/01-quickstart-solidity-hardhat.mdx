...
You should see a prompt showing what test accounts automatically were generated for you and other infos about your local Anvil testnet.

<CustomDetails summary="click for a preview">
```shell
                            (_) | |
      __ _   _ __   __   __  _  | |
     / _` | | '_ \  \ \ / / | | | |
...
<CustomDetails summary="Connect Metamask to Localhost 8545 ">
![](./images/metamask-add-local-testnet-2025-01-13.png)
</CustomDetails>
...
<CustomDetails summary="File explorer > Workspaces > Create blank">
![](./images/metamask-connect-to-arb-sepolia-2025-01-12.gif)
</CustomDetails>
...
<CustomDetails summary=" > Workspaces > Create blank">
  ![](./images/metamask-connect-to-arb-sepolia-2025-01-12.gif)
</CustomDetails>
