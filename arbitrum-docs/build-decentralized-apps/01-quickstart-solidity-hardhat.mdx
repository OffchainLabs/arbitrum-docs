...
### Deploy the smart contract to Remix's VM

Now that you have compiled your smart contract, it's ready to deploy

<CustomDetails summary="Deploy > Remix VM > Deploy > Copy Deployed contract's address">
![](./images/remix-metamask-deploy-to-vm-2025-01-12.gif)
</CustomDetails>
...
<CustomDetails summary="File explorer > Workspaces > Create blank">
  ![](./images/metamask-connect-to-arb-selpolia-2025-01-12.gif)
</CustomDetails>
