...
- Get to https://remix.ethereum.org 
- Create a blank workspace 
- Upload `VendingMachine.sol`
- Deploy the contract to Remix's Remix VM
- Add Metamask to your browser
- Add Arbitrum Sepolia testnet to Metamask
- Add Metamask to Remix provider
- Swap your coins with https://bridge.arbitrum.io 
- Deploy the contract to Arbitrum Sepolia testnet
- Copy the contract address
- Paste the contract address in the `VendingMachine` widget
- 
...
Let's implement the blockchain version of the above vending machine using Arbitrum.
...
The <a data-quicklook-from='ethereum-wallet'>wallet</a> we'll use to interact with our vending machine. See [metamask.io](https://metamask.io/) to install.
...
The package manager we'll use to install our dependencies. See [yarnpkg.com](https://yarnpkg.com/) to install.
