...
These documents are usually authored by partner teams, but can be authored by anyone. They follow the same general process that [core docs](/contribute.md#add-a-new-core-document) follow, in addition to the following guidelines:
...
5.  **Limited document types**
    - To manage our team's limited capacity, third-party documents must be either **_Quickstarts_**, **_How-tos_**, or **_Concepts_**. See [document types](/contribute.md#document-type-conventions).
