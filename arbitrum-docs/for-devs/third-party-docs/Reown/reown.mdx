...
<ImageZoom
  src="/img/third-party-reown1.png"
  alt=""
  className="img-600px"
/>
...
<ImageZoom
  src="/img/third-party-reown3.png"
  alt=""
  className="img-600px"
/>
...
<ImageZoom
  src="/img/third-party-reown4.png"
  alt=""
  className="img-600px"
/>
...
<ImageZoom
  src="/img/third-party-reown6.png"
  alt=""
  className="img-600px"
/>
...
2. `metadata` - (*optional*)This object contains information about our application that will be used by AppKit. This includes the name of the app, the description, the url and the icons representing our app.
