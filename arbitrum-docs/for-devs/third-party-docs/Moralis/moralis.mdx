...
With Moralis [<ins>Token API</ins>](https://moralis.io/api/token/?utm_source=arbitrum-docs&utm_medium=partner-docs) you can get `ERC-20` token data like prices, ownership, metadata, transfers, approvals, liquidity, mints and burns.
