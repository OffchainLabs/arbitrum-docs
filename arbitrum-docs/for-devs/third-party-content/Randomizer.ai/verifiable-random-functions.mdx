...
The following document was contributed by [@DeanPress](https://twitter.com/Deanpress). Give them a shoutout if you find it useful!
...
For instructions on how to integrate a VRF into your own Arbitrum smart contract using Rand, refer to Randomizer.ai's [Use Verifiable Random Functions in Arbitrum](./dev-how-tos/how-to-use-vrfs).
