...
For instructions on how to integrate a VRF into your own Arbitrum smart contract using Rand, refer to Randomizer.ai's [Use Verifiable Random Functions in Arbitrum](./how-to-use-vrfs).
