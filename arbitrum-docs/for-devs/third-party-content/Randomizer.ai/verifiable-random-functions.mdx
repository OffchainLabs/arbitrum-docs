...
The following third-party document was contributed by [@DeanPress](https://twitter.com/Deanpress). Give them a shoutout if you find it useful!
...
[^1]: [Randomizer.ai](https://randomizer.ai/) is one such solution. Refer to [Use Verifiable random functions in Arbitrum](./how-to-use-vrfs) to learn how to integrate Randomizer's VRFs into your smart contracts.