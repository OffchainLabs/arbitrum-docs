...
description: Learn how to generate verifiable, unpredictable random numbers in your Arbitrum smart contracts by using Randomizer.ai's verifiable random numbers (VRFs).
