...
| `gasLimit`   | Value is fixed at `0x4000000000000`, but it's important to note that Arbitrum One currently has a 32M gas limit per block. See [Chain params](/for-devs/chain-params.mdx) for the gas limit of other chains |
