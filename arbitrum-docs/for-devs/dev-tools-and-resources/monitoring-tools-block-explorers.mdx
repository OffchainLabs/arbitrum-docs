...
DexGuru Block Explorer provides familiar UI with data on transactions, blocks, account balances and more. Developers could use it to verify smart contracts and debug transactions with interactive traces and logs visualization.

- DexGuru Arbitrum One Explorer: [https://arbitrum.dex.guru/](https://arbitrum.dex.guru/)
- DexGuru Arbitrum Nova Explorer: [https://nova.dex.guru/](https://nova.dex.guru/)
