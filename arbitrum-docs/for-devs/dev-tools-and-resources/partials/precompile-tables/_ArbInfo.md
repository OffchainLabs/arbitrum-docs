<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <a
          href="https://github.com/OffchainLabs/nitro/blob/v2.3.0/precompiles/ArbInfo.go#L17"
          target="_blank"
        >
          Implementation
        </a>
    ...
    <tr>
      ...
      <td>
        <a
          href="https://github.com/OffchainLabs/nitro/blob/v2.3.0/precompiles/ArbInfo.go#L25"
          target="_blank"
        >
          Implementation
        </a>
