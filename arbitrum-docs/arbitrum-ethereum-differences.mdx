...
- `104` - `ArbitrumRetryTxType`: Used to [redeem a retryable ticket](arbos/l1-to-l2-messaging#redeeming-a-retryable) on L2, which finalizes a L2 to L1 message that failed to redeem automatically (usually due to low gas)
