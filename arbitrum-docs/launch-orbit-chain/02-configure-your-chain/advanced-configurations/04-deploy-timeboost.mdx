...
```bash
cast call --rpc-url=http://localhost:8449 <Your chain's endpoint> <Your ExpressLaneAuction address> "biddingToken()(address)"
...
Update your sequencer node configuration to enable Timeboost functionality. Add the following to your node's configuration file:
