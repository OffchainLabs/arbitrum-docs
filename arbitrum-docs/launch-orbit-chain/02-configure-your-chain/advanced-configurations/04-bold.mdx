...
<a data-quicklook-from="bold">Arbitrum BoLD</a> is the latest iteration of the Optimistic Rollup dispute protocol used by Arbitrum chains today, like Arbitrum One. This page is intended for Orbit chain owners/operators and assumes knowledge of Arbitrum BoLD is and experience upgrading an Arbitrum chain's Rollup contracts.
...
The following configuration parameters can be applied when deploying or managing your Orbit chain. For an example of a configuration, feel free to reference [Arbitrum One's configuration](https://github.com/OffchainLabs/nitro-contracts/blob/main/scripts/files/configs/arb1.ts).
