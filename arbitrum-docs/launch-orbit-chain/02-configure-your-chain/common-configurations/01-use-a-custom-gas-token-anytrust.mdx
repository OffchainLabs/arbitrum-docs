---
title: 'How to configure a custom gas token for your AnyTrust Orbit chain'
description: 'Learn how to deploy your AnyTrust Orbit chain with a custom gas token'
author: jose-franco
sme: jose-franco
sidebar_position: 3
content_type: how-to
...
These methods use L1 to refer to the parent chain of the Orbit chain.
