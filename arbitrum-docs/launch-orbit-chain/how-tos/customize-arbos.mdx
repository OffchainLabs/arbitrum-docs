...
Here, we will provide you with 4 examples that need to add ArbOS Upgrade-related code:
...
Also, please make sure that your program cannot call the `state.SetNewMyNumber` or other functions may change the value of `myNumber` before ArbOS V21. 
