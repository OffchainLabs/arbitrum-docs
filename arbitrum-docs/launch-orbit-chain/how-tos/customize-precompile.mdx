...
Next, follow the steps in [How to customize your Orbit chain's behavior](./customize-stf.mdx#41-build-a-dev-image) to build a modified Arbitrum Nitro node docker image and run it.
