...
Run Nitro by following the instructions (note the instructions provided in [How to run a full node](/node-running/how-tos/running-a-full-node#putting-it-all-together) cannot be used to start an Orbit node):
