...
(⚠️⚠️⚠️ The tutorial only works if you use eth_call, if you want to add non-view/pure methods or call from other contracts, it will break validation, but we will have how to update the wasm module root tutorial to fix this soon.)
