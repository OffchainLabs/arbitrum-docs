...
```shell
git clone --branch @@nitroVersionTag=v3.5.0@@ <https://github.com/OffchainLabs/nitro.git>
cd nitro
...
Using your favorite code editor, open an existing precompile from the [precompiles implementation][precompile_impl_dir_link] directory, `/@@nitroPathToPrecompiles=precompiles@@`. We'll use `ArbSys.go` as an example. Open the corresponding Go implementation file (`ArbSys.go`) and add a simple `SayHi` method:
...
Then, open the corresponding Solidity interface file (`ArbSys.sol`) from the [precompiles interface][precompile_interface_dir_link] directory, `/@@nitroContractsPathToPrecompilesInterface=src/precompiles@@`, and add the required interface. Ensure that the method name on the interface matches the name of the function you introduced in the previous step, `camelCased`:
...
First, navigate to the [precompiles implementation][precompile_impl_dir_link] directory, `/@@nitroPathToPrecompiles=precompiles@@`, and create a new precompile implementation file called `ArbHi.go`. We'll define a new method, and we'll give it an address:
...
Navigate to the [precompiles interface][precompile_interface_dir_link] directory, `/@@nitroContractsPathToPrecompilesInterface=src/precompiles@@`, create `ArbHi.sol`, and add the required interface. Ensure that the method name on the interface matches the name of the function you introduced in the previous step, `camelCased`:
...
[precompile_impl_dir_link]: https://github.com/OffchainLabs/@@nitroRepositorySlug=nitro@@/blob/@@nitroVersionTag=v3.5.0@@/@@nitroPathToPrecompiles=precompiles@@/
[precompile_interface_dir_link]: https://github.com/OffchainLabs/@@nitroContractsRepositorySlug=nitro-contracts@@/blob/@@nitroContractsCommit=763bd77906b7677da691eaa31c6e195d455197a4@@/@@nitroContractsPathToPrecompilesInterface=src/precompiles@@/
...
[arbosstate_file_link]: https://github.com/OffchainLabs/@@nitroRepositorySlug=nitro@@/blob/@@nitroVersionTag=v3.5.0@@/@@nitroPathToArbosState=arbos/arbosState@@/arbosstate.go
[arbosstate_link]: https://github.com/OffchainLabs/nitro/blob/v2.2.0/arbos/arbosState/arbosstate.go#L38
[storage_link]: https://github.com/OffchainLabs/@@nitroRepositorySlug=nitro@@/blob/@@nitroVersionTag=v3.5.0@@/@@nitroPathToStorage=arbos/storage@@/storage.go
