...
Both of these APIs are critical in the setup process and were previously discussed with examples provided on the  [Rollup deployment page](orbit-sdk-deploying-rollup-chain.md#rollup-config-param). 
