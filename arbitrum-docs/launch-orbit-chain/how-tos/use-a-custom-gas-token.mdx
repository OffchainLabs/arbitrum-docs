...
After deploying the chain, you must reset the base fees of the parent chain by calling the following functions in the [ArbOwner](/for-devs/dev-tools-and-resources/precompiles.mdx#arbowner) precompile:
...
In either case we strongly recommend taking these steps to avoid any issues with chain economics. You can read more about how Nitro manages fees in [Gas and fees](/arbos/gas.mdx).
