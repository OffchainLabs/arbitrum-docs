...
The parameter that governs an Orbit chain's throughput limit is known as the `gas speed limit`. The gas speed limit is measured in *gas per second* and is used as a threshold for increasing gas prices.
