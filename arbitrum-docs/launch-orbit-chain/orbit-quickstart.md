...
| **Owner**                     | The administrative Ethereum address that will deploy, own, and update your chain's base contracts. This will default to your connected wallet's address. Note that you'll have to paste the private key associated with this wallet into a local JSON file later; consider using a burner account in the spirit of opsec hygiene. |
