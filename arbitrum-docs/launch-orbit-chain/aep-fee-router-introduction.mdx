...
## How can I setup and AEP fee router on my Orbit chain?
You can learn how to setup your AEP fee router in [implementation guide](launch-orbit-chain/how-tos/set-up-aep-fee-router).
