...
| **Customizable fee token**          | Orbit chains can alternative ERC-20 tokens as the native token on the network used for gas payments, facilitating seamless integration with your dApp's ecosystem. This is currently supported on AnyTrust chains.                                                                                                                                                                                                                                                                                                                                                                                                                    |
