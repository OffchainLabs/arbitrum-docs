...
The Arbitrum Orbit core technology has undergone a comprehensive audit and is prepared for deployment on Mainnet. To optimize the experience, we recommend deploying an Orbit chain to Testnet before proceeding to Mainnet. 

It is important to note, that with novel technology, there are inherent risks involved. 
