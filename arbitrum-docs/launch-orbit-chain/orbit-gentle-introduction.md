...
Yes! Your Orbit chain isolates compute and storage resources away from public L2s and into self-managed resources, but **it retains the same underlying protocol** (AnyTrust or Rollup) that tells all other Orbit chains how to process transactions[^2].
