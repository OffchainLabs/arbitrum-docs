...
Adopting <a data-quicklook-from="bold">Arbitrum BoLD</a> brings new security benefits to Orbit chains that are independent of whether or not validation is permissionless. These new security benefits include improved resistance to delay attacks and increased censorship resistance for `L3s`. Because of these new security benefits, we strongly recommend teams to upgrade their Orbit chains to use Arbitrum BoLD (for the security benefits) but **keep validation permissioned**. Below is a quick breakdown of the impacts of permissioned BoLD vs. permissionless BoLD on your Orbit chain:
 ...
 <table style={{width: '100%'}}>
      <thead>
        <tr>
          <th colSpan="2">
            <strong>Permissioned BoLD on an Orbit chain</strong>
          </th>
        </tr>
        <tr>
          <th style={{width: '50%'}}><strong>Benefits</strong></th>
          <th style={{width: '50%'}}><strong>Caveats</strong></th>
        </tr>
      </thead>
      <tbody>
        <tr>
          <td style={{width: '50%'}}><strong>Improved resistance to delay attacks</strong></td>
          <td style={{width: '50%'}}>Permissioned validation: only entities on allowlist can resolve disputes</td>
        </tr>
        <tr>
          <td style={{width: '50%'}}><strong>Increased censorship resistance for L3s</strong></td>
          <td style={{width: '50%'}}></td>
        </tr>
        <tr>
          <td style={{width: '50%'}}><strong>Use of any <code>ERC-20</code> as the bonding token</strong></td>
          <td style={{width: '50%'}}></td>
        </tr>
        <tr>
          <td style={{width: '50%'}}><strong>Be on the latest iteration of Arbitrum technology</strong>. Simplify future security & feature updates</td>
          <td style={{width: '50%'}}></td>
        </tr>
      </tbody>
    </table>
...
<table style={{width: '100%'}}>
    <thead>
        <tr>
            <th colSpan="2">
                <strong>Permissionless BoLD on an Orbit chain</strong>
            </th>
        </tr>
        <tr>
            <th style={{width: '50%'}}><strong>Benefits</strong></th>
    ...
    <tbody>
        <tr>
            <td style={{width: '50%'}}><strong>Improved resistance to delay attacks</strong></td>
            <td style={{width: '50%'}}>Resource exhaustion attacks: challenges require computing and financial resources to participate in. An attacker with significantly more resources than defenders could compromise chain safety.</td>
        </tr>
        <tr>
            <td style={{width: '50%'}}><strong>Increased censorship resistance for L3s (via Censorship Timeout)</strong></td>
            <td style={{width: '50%'}}>Liveness impact: if the cost of a challenge is cheap, an attacker can cheaply open a challenge and prevent chain progress by censoring honest moves.</td>
        </tr>
        <tr>
            <td style={{width: '50%'}}><strong>Use of any <code>ERC-20</code> as the bonding token</strong></td>
            <td style={{width: '50%'}}>Liquidity and price impacts: if a low-liquidity <code>ERC-20</code> token is used as the bonding token, and a challenge occurs, it might have adverse effects on liquidity and price.</td>
        </tr>
        <tr>
            <td style={{width: '50%'}}><strong>Be on the latest iteration of Arbitrum technology, simplifying future updates</strong></td>
            <td style={{width: '50%'}}>Grieving attacks: a higher reward for defenders might incentivize self-challenges, effectively lowering the cost of attack.</td>
        </tr>
        <tr>
            <td style={{width: '50%'}}><strong>Anyone can propose state roots</strong></td>
            <td style={{width: '50%'}}>More expensive engineering overhead and infrastructure costs.</td>
        </tr>
    </tbody>
</table>
