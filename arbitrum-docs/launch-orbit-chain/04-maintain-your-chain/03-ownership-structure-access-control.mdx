...
author: dzgoldman
sme: dzgoldman
target_audience: 'RaaSes and developers deploying and maintaining Orbit chains.'
content_type: how-to
---
...
A chain owner is simply an address; it is set by the Orbit chain's deployer and can represent any sort of governance scheme. I.e., it could be an EOA (as is set via the [Orbit Quickstart](launch-orbit-chain/orbit-quickstart.md)), a Multisig, a governance token system, etc.
