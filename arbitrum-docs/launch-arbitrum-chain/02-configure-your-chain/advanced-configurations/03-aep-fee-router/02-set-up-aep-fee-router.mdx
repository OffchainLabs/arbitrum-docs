...
Scenario 2: You are an L3 Arbitrum Chain that settles to another L2. The custom gas token you are using exists on L1.

Scenario 3: You are an L3 Arbitrum Chain that settles to another L2. The custom gas token doesn't exist on L1.
