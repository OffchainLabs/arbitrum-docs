...
Optionally, an Arbitrum chain can decide to deduct assertion costs by following the instructions in the [Deducting Assertion Costs](/launch-arbitrum-chain/02-configure-your-chain/advanced-configurations/03-aep-fee-router/03-calculate-aep-fees.mdx#assertion-costs) section:
