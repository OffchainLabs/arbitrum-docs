...
Scenario 2: You are an L3 Arbitrum Chain that settles to Arbitrum L2.

Scenario 3: You are an L3 Arbitrum Chain that settles to another L2.

(If the Custom Gas Token you are using to send payment does not exist on Ethereum L1, please reach out)
