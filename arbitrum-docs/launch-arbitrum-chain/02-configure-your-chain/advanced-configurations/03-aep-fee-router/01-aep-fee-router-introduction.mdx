...
You can learn how to set up your AEP fee router in [implementation guide](/launch-orbit-chain/02-configure-your-chain/advanced-configurations/03-aep-fee-router/02-set-up-aep-fee-router.mdx).
