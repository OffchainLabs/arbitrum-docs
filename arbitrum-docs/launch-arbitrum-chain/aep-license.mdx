...
- L3s that settle to parent chains other than Arbitrum One and Nova must contribute [net chain revenue](/launch-arbitrum-chain/02-configure-your-chain/advanced-configurations/aep-fee-router/calculate-aep-fees#calculating-aep-fees), where 8% flows to the DAO and 2% to the developer guild.
