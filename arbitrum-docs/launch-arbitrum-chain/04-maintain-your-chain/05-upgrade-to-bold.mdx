...
**Please pay close attention** to every parameter since it will override the existing configuration of your chain. Feel free to reference this page on [BoLD's configuration parameters](../../launch-arbitrum-chain/02-configure-your-chain/advanced-configurations/04-bold.mdx).
