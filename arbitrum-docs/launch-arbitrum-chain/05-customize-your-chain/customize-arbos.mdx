...
you need continue to modify [precompile.go](https://github.com/OffchainLabs/@@nitroRepositorySlug=nitro@@/blob/@@nitroVersionTag=v3.6.2@@/@@nitroPathToPrecompiles=precompiles@@/precompile.go).
