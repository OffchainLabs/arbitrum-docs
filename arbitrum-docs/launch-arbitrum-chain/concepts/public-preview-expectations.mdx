...
Refer to the [Arbitrum chain quickstart](/launch-arbitrum-chain/arbitrum-chain-quickstart.md) for instructions that walk you through the process of deploying your Arbitrum chain to Testnet.
