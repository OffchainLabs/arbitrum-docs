...
| **Nitro extensibility**             | Arbitrum chains will have access to all Nitro code upgrades, feature additions, and improvements, giving your Arbitrum chain the option to stay up-to-date and incorporate the latest and greatest in Ethereum scaling technology.                                                                                                                                                                                                                                                                                                                 |
...
| **Low prototyping costs**           | Arbitrum chains can be easily created. See the [Arbitrum Quickstart](./arbitrum-quickstart) for step-by-step instructions.                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
Visit the [Arbitrum Quickstart](./arbitrum-quickstart.md), start tinkering, and let us know how it goes - we're excited to learn and grow with you! 🚀
