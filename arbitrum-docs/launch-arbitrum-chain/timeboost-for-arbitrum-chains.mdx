...
As explained in the guide on [how to deploy and configure Timeboost](/launch-arbitrum-chain/02-configure-your-chain/advanced-configurations/04-deploy-timeboost.mdx), there are three core components to Timeboost:
