...
| [![](../assets/e.png)][gis4] [`getGasAccountingParams`][gi4]`()`                    | Get the chain speed limit, pool size, and transaction gas limit                                  |
...
| [`setMaxTxGasLimit`][o8]`(limit)`                             | Sets the maximum size a transaction (and block) can be                          |
| [`setL2GasPricingInertia`][o9]`(sec)`                         | Sets the L2 gas pricing inertia                                                 |
| [`setL2GasBacklogTolerance`][o10]`(sec)`                      | Sets the L2 gas backlog tolerance                                               |
...
| [![](../assets/e.png)][rts5] [`redeem`][rt5]`(ticket)`                | Schedule an attempt to redeem the retryable, donating all of the call's gas &nbsp; | Happens in a future transaction |
...
| Events                                                         |                                                                          |
| :------------------------------------------------------------- | :----------------------------------------------------------------------- |
| [![](../assets/e.png)][ses0] [`L2ToL1Transaction`][se0] &nbsp; | Logs a send transaction from L2 to L1, including data for outbox proving |
