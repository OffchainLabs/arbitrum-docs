...
<MermaidWithHtml>
  ...
  <NodeDescriptions>
    ...
    <NodeDescription for='3'>Logic that determines the user's deposit alone will make the submission succeed</NodeDescription>
    <NodeDescription for='5'>If success; a ticket is created and added to the retryable buffer
    ...
    <NodeDescription for='4'>If fail; Ticket creation fails and no funds are deducted</NodeDescription>
