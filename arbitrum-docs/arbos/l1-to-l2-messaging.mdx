...
<MermaidWithHtml>
  ...
  <NodeDescriptions>
    ...
    <NodeDescription for='4'>excessFeeRefundAddress gets refunded with (maxGas - gasUsed) * gasPrice. Note that this amount is capped by gasUsed * baseFee in the auto-redeem</NodeDescription>
  </NodeDescriptions>
</MermaidWithHtml>
