...
This could be improved through more concrete examples
...
:::caution Editor note
 ...
 - If we feel like this table is a value-add, we can fill it in, partialize it, and refer to it elsewhere
...
:::caution Editor note
 ...
 - Procedural instructions are hidden below this banner, intent is to move it into a dedicated procedural doc (how-to)
