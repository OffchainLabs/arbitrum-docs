...
<MermaidWithHtml>
  ...
  <NodeDescriptions>
    <NodeDescription for='1'>Decentralized apps may need to read and write state to both layers, to know that their L2 transactions are settling to Ethereum L1, to expose functionality to users on both layers, to enjoy guarantees of bidirectional state synchronization between layers.</NodeDescription>
