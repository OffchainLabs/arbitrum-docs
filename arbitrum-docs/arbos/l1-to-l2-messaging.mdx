...
<MermaidWithHtml>
  <Nodes>
    <Node id="1">🧍</Node>
    <Node id="2">Inbox.createRetryableTicket()</Node>
    <Node id="3">somethingElse()</Node>
    <Node id="4">Fail</Node>
    <Node id="5">Success</Node>
  ...
  <NodeDescriptions>
    <NodeDescription for='1'>The user....</NodeDescription>
    <NodeDescription for='2'>An asynchronous function that...</NodeDescription>
    <NodeDescription for='3'>Logic within that determines...</NodeDescription>
    <NodeDescription for='3'>If success...</NodeDescription>
    <NodeDescription for='3'>If fail...</NodeDescription>
  </NodeDescriptions>
</MermaidWithHtml>
