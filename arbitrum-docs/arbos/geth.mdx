...
Please note that Geth VM trace tool on Arbiscan will not be functional for Arbitrum legacy transactions due to our non-use of Geth in the initial Arbitrum version.
