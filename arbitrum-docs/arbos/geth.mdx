...
APIBackend implements the [`ethapi.Backend`][ethapi.bakend_link] interface, which allows simple integration of the Arbitrum chain to existing Geth API. Most calls are answered using the Backend member.
