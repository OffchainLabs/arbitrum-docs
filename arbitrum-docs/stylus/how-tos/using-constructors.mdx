...
When your contract inherits from another contract with a constructor, you must manually call the parent constructor:

```rust
#[public]
impl ChildContract {
    #[constructor]
    pub fn constructor(&mut self, child_param: U256) -> Result<(), Error> {
        // Call parent constructor first
        self.parent_constructor()?;
        
        // Initialize child-specific state
        self.child_value.set(child_param);
        
        Ok(())
    }
    
    fn parent_constructor(&mut self) -> Result<(), Error> {
