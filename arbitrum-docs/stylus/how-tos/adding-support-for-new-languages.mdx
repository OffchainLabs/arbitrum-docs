---
title: 'Adding Stylus support for new programming languages'
sidebar_label: 'Adding support for new programming languages'
description: 'A guide on adding support for more programming languages to Stylus'
author: rauljordan
sme: rauljordan
