...
The Stylus testnet settles directly to the [Arbitrum Sepolia](/build-decentralized-apps/03-public-chains.mdx#arbitrum-sepolia) testnet. Follow these steps to acquire testnet ETH on the Stylus testnet:
