...
- Latest Docker Image: <code>@@latestNitroNodeImage=offchainlabs/nitro-node:v3.5.0-bdc2fd2@@</code>
...
- Here is an example of how to run nitro-node:
  ...
  ```shell
  docker run --rm -it  -v /some/local/dir/arbitrum:/home/user/.arbitrum -p 0.0.0.0:8547:8547 -p 0.0.0.0:8548:8548 @@latestNitroNodeImage=offchainlabs/nitro-node:v3.5.0-bdc2fd2@@ --parent-chain.connection.url https://l1-node:8545 --chain.id=<L2ChainId> --http.api=net,web3,eth --http.corsdomain=* --http.addr=0.0.0.0 --http.vhosts=*
  ```
