...
We recommend using the [Offchain Labs Community Helm Charts](https://github.com/OffchainLabs/community-helm-charts) for deploying your high availability sequencer setup. These charts provide pre-configured templates for all the necessary components and make it easier to maintain your deployment.
