...
There is a flag in sequencer's config which is `--node.seq-coordinator.my-url`, you need to make sure this url is your sequencer's endpoint url and the url of your sequencer you add to sequencer coordinator manager is the same as this flag.
