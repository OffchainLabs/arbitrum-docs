...
| **`StakeLatest`**  | This validator will stay staked on the latest correct assertion found, and will challenge any bad assertions that it finds (this strategy is only available in pre-BoLD chains)                                                                                                                                                                                 | Gas used every time a new assertion is created                                                          |
