...
Although there are alpha and beta versions of the Arbitrum Nitro software, use only the release version when running your node. Running alpha or beta versions is not supported and might lead to unexpected behaviors.
