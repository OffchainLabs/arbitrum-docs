...
The following table shows this information for Arbitrum Sepolia:

| Network          | Auction contract                                                              | Autonomous auctioneer endpoint  |
| ---------------- | ----------------------------------------------------------------------------- | ------------------------------- |
| Arbitrum Sepolia | <AEL address="0x991DbEDf388CB5925318f06362D4fCa7b040527D" chainID={421614} /> | https://sepolia-bv.arbitrum.io/ |
| Arbitrum One | Pending on-chain governance vote | Pending on-chain governance vote
| Arbitrum Nova | Pending on-chain governance vote | Pending on-chain governance vote
