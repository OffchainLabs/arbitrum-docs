    ...
    <table className="small-table" id="troubleshooting-table-info">
      <tbody>
        ...
        <tr className="scenario">
          ...
          <td>
            This is usually because your node shut down ungracefully. In most cases it will recover
        ...
        <tr className="scenario">
          ...
          <td>
            Nitro (and Geth) can consume a lot of memory depending on request load. It's possible
        ...
        <tr className="scenario">
          ...
          <td>
            ...
            but accidentally ends up blocking node runners.
          </td>
        </tr>
        <tr className="scenario">
          <td>
        ...
        <tr className="scenario">
          ...
          <td>
            Please check your parent chain endpoint, this is because there are something going wrong
        ...
        <tr className="scenario">
          ...
          <td>
            This is a normal behavior while the node catching up to tip of chain, once a node has
      ...
      <tbody>
        ...
        <tr className="scenario">
          ...
          <td>
            ...
            the node without prune flag and after your node back to normal, then graceful shutdown
      ...
      <tbody>
        ...
        <tr className="scenario">
          ...
          <td>
            ...
            might modify your node’s code, please refer to to continue set.
          </td>
        </tr>
        <tr className="scenario">
          <td>
