...
- The latest Nitro docker image: `@@latestNitroNodeImage=offchainlabs/nitro-node:v3.6.3-1d5699d@@`
...
@@latestNitroNodeImage=offchainlabs/nitro-node:v3.6.3-1d5699d@@ keygen --dir /data/keys
```
...
template:
    ...
    - command:
        ...
        image: @@latestNitroNodeImage=offchainlabs/nitro-node:v3.6.3-1d5699d@@
...
```shell
docker run --rm -it -v /some/local/dir:/home/user/data --entrypoint datool @@latestNitroNodeImage=offchainlabs/nitro-node:v3.6.3-1d5699d@@ keygen --dir /home/user/data/keys --ecdsa
```
...
```shell
docker run --rm -it -v /some/local/dir:/home/user/data --network="host" --entrypoint datool @@latestNitroNodeImage=offchainlabs/nitro-node:v3.6.3-1d5699d@@ client rpc store --url http://localhost:9876 --message "Hello world" --signing-key /home/user/data/keys/ecdsa
```
...
```shell
docker run --rm -it --network="host" --entrypoint datool @@latestNitroNodeImage=offchainlabs/nitro-node:v3.6.3-1d5699d@@ client rest getbyhash --url http://localhost:9877 --data-hash 0xDataHash
```
