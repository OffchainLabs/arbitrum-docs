...
```shell
docker run -v $(pwd):/data/keyset --entrypoint datool @@latestNitroNodeImage=offchainlabs/nitro-node:v3.6.6-a1deae2@@ dumpkeyset --conf.file /data/keyset/keyset-info.json
```
