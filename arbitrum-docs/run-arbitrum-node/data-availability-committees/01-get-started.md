...
- Craft the new configuration for your chain's nodes (see [run a full orbit node](https://docs.arbitrum.io/node-running/how-tos/running-an-orbit-node#3-anytrust-chains))
