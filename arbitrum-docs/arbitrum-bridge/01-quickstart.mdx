...
The only prerequisite for this quickstart is to have a web3 wallet installed, e.g., Metamask/OKX. If you don't have one, visit Arbitrum's [portal page](https://portal.arbitrum.io/?categories=wallet) to download one.
