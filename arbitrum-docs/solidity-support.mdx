...
- `gasleft()` formerly known as [`msg.gas`](https://docs.soliditylang.org/en/develop/units-and-global-variables.html#block-and-transaction-properties) works the same way it does on Ethereum for L2 gas. The gas used for posting on L1 is intrinsic, meaning that it is used before any code runs. See [how to estimate gas](./devs-how-tos/how-to-estimate-gas.mdx) for a detailed breakdown on how gas is calculated.
