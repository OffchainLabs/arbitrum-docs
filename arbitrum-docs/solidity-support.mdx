...
- `gasleft()` formerly known as [`msg.gas`](https://docs.soliditylang.org/en/develop/units-and-global-variables.html#block-and-transaction-properties) deducts L1 gas used before smart contracts have access to measure gas left. See [how to estimate gas](./devs-how-tos/how-to-estimate-gas.mdx) for a detailed breakdown on how gas is calculated.
