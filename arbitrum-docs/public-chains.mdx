...
**Arbitrum Nova**: Arbitrum Nova is the first mainnet [AnyTrust](./inside-anytrust.mdx) chain. The following are the members of the initial data availability committee (DAC):
- Consensys
- Google Cloud
- Offchain Labs
- P2P
