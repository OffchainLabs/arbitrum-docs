...
| Resource                                                                     | Description                                                                         |
| ---------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| [Orbit gentle introduction](/launch-orbit-chain/01-a-gentle-introduction.md) | Targeted at readers who want to understand Orbit's value proposition and use cases. |
