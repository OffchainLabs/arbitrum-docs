...
<p>Running an Arbitrum relay locally <a href="https://developer.offchainlabs.com/node-running/running-a-node#arb-relay">Arb-Relay </a> gives users the ability to subscribe to the Sequencer feed at for real-time data as the Sequencer accepts and orders transactions off-chain. </p>
