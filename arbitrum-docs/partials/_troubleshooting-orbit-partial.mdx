...
<p>
Yes! Arbitrum chain's core technology has undergone a comprehensive audit and is now able to support deployments to mainnet. You can read more about it <a href="https://docs.arbitrum.io/launch-arbitrum-chain/concepts/public-preview-expectations#arbitrum-chain-is-mainnet-ready-but-deploy-to-testnet-first">here</a>.
</p>
...
<p>
However, Arbitrum chains that settle to a parent chain other than Arbitrum One or Nova are subject to additional licensing guidelines under the <a href="https://docs.arbitrum.foundation/aep/ArbitrumExpansionProgramTerms.pdf">AEP</a>.
</p>
...
<p>
Arbitrum chains are fully EVM-compatible. Most tools that support Ethereum should be able to support an Arbitrum chain. There are, however, certain differences that developers need to keep in mind when building on an Arbitrum chain. You can find them <a href="https://docs.arbitrum.io/for-devs/concepts/differences-between-arbitrum-ethereum/overview">here</a>.
</p>
