...
[Economics of Disputes](https://docs.arbitrum.io/how-arbitrum-works/bold/bold-economics-of-disputes), which also explains the cost profile and spam prevention in BoLD. In short, the
actual cost of a bond encompasses many costs associated with participating in the dispute game. More information on the bond sizes and how they were calculated can be found in the [Economics of Disputes](https://docs.arbitrum.io/how-arbitrum-works/bold/bold-economics-of-disputes) document mentioned above.
