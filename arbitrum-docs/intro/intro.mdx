...
The Arbitrum One and Nova chains are ownered by the Governacne system; to learn more, see the [Arbitrum Governacne docs](http://docs.arbitrum.foundation/).