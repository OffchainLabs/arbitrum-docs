...
const sidebars = {
  ...
  // Build apps sidebar optimized for Get Started entry point (Build decentralized apps expanded, Stylus collapsed)
  buildAppsSidebarFromGetStarted: [
    {
      type: 'category',
      label: 'Build decentralized apps',
      collapsed: false,
  ...
  // Build apps sidebar optimized for Stylus entry point (Stylus expanded, Build decentralized apps collapsed)
