...
To determine how to configure the gas target for your chain, refer to the [Dynamic pricing for Arbitrum chains page](/launch-arbitrum-chain/chain-config/costs/dynamic-pricing.mdx). To calculate the values for your chain, refer to the [How to calculate the values for your chain section](/launch-arbitrum-chain/chain-config/costs/dynamic-pricing.mdx#how-to-calculate-the-values-for-your-chain) on the same page.
