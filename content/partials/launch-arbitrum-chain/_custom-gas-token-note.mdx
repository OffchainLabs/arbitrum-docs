...
To enable this feature for your chain, see our guide on [enabling native mint/burn for gas tokens](/docs/launch-arbitrum-chain/configuration/costs/configure-native-mint-burn-gas-token).
