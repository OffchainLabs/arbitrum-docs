<Callout type="info" title="Native Mint/Burn for Custom Gas Tokens">
...
To enable this feature for your chain, see our guide on [enabling native mint/burn for gas tokens](/docs/launch-arbitrum-chain/chain-config/costs/configure-native-mint-burn).
