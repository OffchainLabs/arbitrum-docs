...
- **Limited transparency compared to onchain**: Offchain data storage (even with proofs) may reduce immediate verifiability for all users, as nodes must query external sources, which contrasts with Ethereum's direct onchain access.
