...
- **Higher costs**: Higher transaction fees due to the cost of posting all data onchain to the parent layer.
...
- **Throughput**: Potentially lower throughput compared to AnyTrust mode, as the onchain data posting can limit scalability for high-volume, low-value transactions.
