...
title: 'Third-party RPC Endpoints Reference'
description: 'List of third-party RPC providers for Arbitrum networks'
author: anegg0
...
<VanillaAdmonition type="info" title="WANT TO BE LISTED HERE?">
...
<VanillaAdmonition type="info" title="Need support for Nova 3rd party tooling?">
...
| [Alchemy](https://dashboard.alchemy.com/?utm_source=chain_partner&utm_medium=referral) | ✅       |           | ✅           | ✅         | Available on paid plans        |
...
| [SwiftNodes](https://swiftnodes.io/arbitrum-rpc)                                       | ✅       |           |              | ✅         |                                |
...
For a live latency comparison of the public no-key Arbitrum endpoints listed above, see the [OpenChainBench Arbitrum RPC benchmark tool](https://openchainbench.com/benchmarks/arbitrum-rpc). Measurements are probed from three regions every minute and published as p50, p95 and p99 latency under an open methodology and CC BY 4.0 license.
