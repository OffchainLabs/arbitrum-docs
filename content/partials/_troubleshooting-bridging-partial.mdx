...
The variability of the dispute window comes from the slight variance of block times. Arbitrum One's dispute window is @@arbOneDisputeWindowBlocks=45818@@ blocks; this converts to about @@arbOneDisputeWindowDays=6.4@@ days, assuming slightly more than @@l1SlotTimeSeconds=12@@ seconds per block, the average block time of Ethereum.
