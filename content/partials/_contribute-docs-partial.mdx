...
This document shows you how to craft and publish Arbitrum documentation. Familiarity with [Markdown](https://www.markdownguide.org/basic-syntax/) syntax, Github, and [Fumadocs](https://fumadocs.dev/docs) is expected.
...
2.  Issue a `Draft` pull request into `master`. Pull requests into `master` generate a preview of your changes via a PR-specific Vercel deployment; this preview will update as you push commits to your remote.
...
You can use banners (also called "admonitions") to set expectations for your readers and to emphasize important callouts. Use these conservatively, as they interrupt the flow of the document.
...
#### Can I point to my product from core docs? For example—if my product hosts a public RPC endpoint, can I add it to your [RPC endpoints and providers](/docs/arbitrum-essentials/reference/node-providers) page?
