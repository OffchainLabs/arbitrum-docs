...
If you are a chain owner, please refer to the [DAC setup guide](/docs/launch-arbitrum-chain/configuration/data-availability/data-availability-committees/get-started#if-you-are-a-chain-owner) to set it up.

Additionally, for your batch poster to post data to the DAS, follow [Step 3 of How to configure a DAC](/docs/launch-arbitrum-chain/configuration/data-availability/data-availability-committees/configure-dac#step-3-craft-the-new-configuration-for-the-batch-poster) to configure your batch poster node.
