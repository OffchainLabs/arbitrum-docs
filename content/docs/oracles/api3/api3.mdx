...
<VanillaAdmonition type="info">If a dAPI is already active, you can use the proxy address directly. If it is not active, you can activate it by clicking on **Activate** and following the instructions to deploy a proxy contract.</VanillaAdmonition>
