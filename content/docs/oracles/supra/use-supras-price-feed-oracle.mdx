...
sidebar_label: 'Supra price feed oracle'
content_type: 'how-to'
author: ksdumont
sme: ksdumont
---
...
Shoutout to [@ksdumont](https://github.com/ksdumont) for contributing the following [third-party document](/docs/third-party-docs/contribute)!
