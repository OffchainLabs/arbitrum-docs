...
You will then land on your subgraph's page. All the CLI commands you need are visible on the right side of the page.
...
You'll be prompted to provide some information about your subgraph.
...
![The Publish button on a subgraph page in Subgraph Studio](/img/third-party-thegraph-publish-button.png)
