...
These documents are usually authored by partner teams, but can be authored by anyone. They follow the same general process that [core docs](/docs/contribute#add-a-new-core-document) follow, in addition to the following guidelines:
...
## 1.Eligibility
    ...
    - To submit your project to the Arbitrum portal, [apply using this Google form](<Var name="portalApplicationForm" />).
...
## 5.Limited document types
    ...
    - To manage our team's limited capacity, third-party documents must be either_Quickstarts_,_How-tos_, or_Concepts_. See [document types](/docs/contribute#document-type-conventions).
