...
The [embedded wallet](https://www.openfort.io/embedded-wallet) supports React, React Native, Swift, and Unity. It enables app developers to onboard users and generate wallets for them. Features include:
...
If you're building your own Arbitrum chain and are thinking about owning the wallet, connect with us. [Global wallets](https://www.openfort.io/crossapp-wallet) are designed for you to have a universal sign-on across all the apps in your ecosystem.
...
<VanillaAdmonition type="info" title="Detailed tutorial">
