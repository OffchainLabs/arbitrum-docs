...
By abstracting away the core complexities of the blockchains, Crossmint allows you to build NFT applications without requiring any blockchain experience or holding cryptocurrency, and making the blockchain invisible to end users.
...
<VanillaAdmonition type="info" title="Crossmint Console">
...
<VanillaAdmonition type="info" title="Video Tutorial">
