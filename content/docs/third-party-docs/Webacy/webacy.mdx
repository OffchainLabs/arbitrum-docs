...
[Webacy](https://webacy.com/) is a risk data network that helps wallets and applications protect their users against scams, hacks, and mistakes across the blockchain.

Wallets, protocols, and applications use Webacy throughout their user experience:
