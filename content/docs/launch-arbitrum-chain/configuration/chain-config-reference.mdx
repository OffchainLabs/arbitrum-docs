...
| `DataAvailabilityCommittee` | `false`  | `false` = Rollup (L1 data posting); `true` = AnyTrust ([DAC](/docs/launch-arbitrum-chain/configuration/data-availability/data-availability-committees/get-started)) |
...
<VanillaAdmonition type="warning" title="For informational purposes only">
