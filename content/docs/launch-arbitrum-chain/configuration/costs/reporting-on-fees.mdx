...
1. **L1 Base Fee**: Refunds [<Term id="batch-poster">Batch Poster</Term>](/docs/how-arbitrum-works/deep-dives/batchposter) for <Term id="parent-chain">parent chain</Term> posting costs
...
1. [<Term id="arbos">ArbOS</Term>](/docs/how-arbitrum-works/deep-dives/arbos) consumes batch posting reports
