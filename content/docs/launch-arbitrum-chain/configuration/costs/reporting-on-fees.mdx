...
sidebar_label: 'AEP fee reporting'
...
There are two main <Term id="L1">L1</Term> fee collector addresses:

1. **L1 Base Fee**: Refunds [Batch Poster](/docs/how-arbitrum-works/deep-dives/assertions) for <Term id="parent-chain">parent chain</Term> posting costs
...
1. [ArbOS](/docs/how-arbitrum-works/deep-dives/arbos) consumes batch posting reports
