...
These parameters are separate from congestion pricing. They set what the chain charges for data, not what it charges when demand exceeds the <a data-quicklook-from="gas-target">gas target</a>. To tune congestion pricing, refer to the [Manage gas target](/docs/launch-arbitrum-chain/operate/gas-target) page.
