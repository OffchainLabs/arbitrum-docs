...
- **Parent chain surplus fee**: if configured, these are extra fees rewarded to the [<Term id="batch-poster">Batch Poster</Term>](/docs/how-arbitrum-works/deep-dives/batchposter).
