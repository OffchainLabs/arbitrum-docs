...
While certain restrictions are in place today (see above), some of them may be removed in upcoming releases of the custom gas token feature. Please reach out to the <a data-quicklook-from="offchain-labs">Offchain Labs</a> team with any questions or requests for additions to the custom gas token feature.
...
These methods use <a data-quicklook-from="L1">L1</a> to refer to the parent chain of the Arbitrum chain.
...
In either case we strongly recommend taking these steps to avoid any issues with chain economics. You can read more about how Nitro manages fees in [Gas and fees](/docs/how-arbitrum-works/deep-dives/gas-and-fees).
