...
While Native Mint/Burn was introduced in [ArbOS](/docs/how-arbitrum-works/deep-dives/arbos) 41, we strongly recommend that teams upgrade to [ArbOS 51 Dia](/docs/run-a-node/arbos-releases/arbos51) to enable this feature.
...
| `go-ethereum` fork | Included in [ArbOS 51 Dia](/docs/run-a-node/arbos-releases/arbos51) (please use the latest <a data-quicklook-from="wasm">WASM</a> module root) or later |
