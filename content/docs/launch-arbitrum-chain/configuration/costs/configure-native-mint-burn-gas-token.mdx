...
While Native Mint/Burn was introduced in [<Term id="arbos">ArbOS</Term>](/docs/how-arbitrum-works/deep-dives/arbos) 41, we strongly recommend that teams upgrade to [ArbOS 51 Dia](/docs/run-a-node/arbos-releases/arbos51) to enable this feature.
