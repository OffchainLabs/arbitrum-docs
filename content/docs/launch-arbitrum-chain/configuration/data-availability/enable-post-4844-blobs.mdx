...
Your [ArbOS](/docs/how-arbitrum-works/deep-dives/arbos) version must be **20 or higher**. To check your current version:

#### Method 1: Smart contract call

Call the `arbOSVersion()` function on the ArbSys [precompile](/docs/arbitrum-essentials/precompiles/reference) contract:
...
To enable blob <a data-quicklook-from="transaction">transaction</a> posting, add the following configuration to your [Batch Poster](/docs/how-arbitrum-works/deep-dives/assertions) node:
