...
- The latest Nitro docker image: `@@latestNitroNodeImage=offchainlabs/nitro-node:v3.11.3-beb2108@@`
...
@@latestNitroNodeImage=offchainlabs/nitro-node:v3.11.3-beb2108@@ keygen --dir /home/user/bls_keys
```
...
services:
  das-server:
    image: @@latestNitroNodeImage=offchainlabs/nitro-node:v3.11.3-beb2108@@
...
@@latestNitroNodeImage=offchainlabs/nitro-node:v3.11.3-beb2108@@ keygen --dir /home/user/ecdsa_keys --ecdsa
```
