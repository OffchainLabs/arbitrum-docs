...
offchainlabs/nitro-node:v3.11.3-beb2108 keygen --dir /home/user/bls_keys
```
...
```shell
INFO [...] Starting HTTP-RPC server    addr=0.0.0.0 port=9876 revision=v3.9.9-6b0af88
INFO [...] Starting REST server        addr=0.0.0.0 port=9877 revision=v3.9.9-6b0af88
```
...
offchainlabs/nitro-node:v3.11.3-beb2108 keygen --dir /home/user/ecdsa_keys --ecdsa
```
