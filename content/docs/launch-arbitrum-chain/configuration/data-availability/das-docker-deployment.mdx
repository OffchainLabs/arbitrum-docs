...
<Var name="latestNitroNodeImage" /> keygen --dir /home/user/bls_keys
```
...
services:
  das-server:
    image: <Var name="latestNitroNodeImage" />
...
<Var name="latestNitroNodeImage" /> keygen --dir /home/user/ecdsa_keys --ecdsa
```
