...
```shell
docker run -v $(pwd):/data/keyset --entrypoint anytrusttool @@latestNitroNodeImage=offchainlabs/nitro-node:v3.11.3-beb2108@@ dumpkeyset --conf.file /data/keyset/keyset-info.json
```
