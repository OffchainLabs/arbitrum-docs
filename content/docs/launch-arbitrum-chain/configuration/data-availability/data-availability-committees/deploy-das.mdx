...
1. **An RPC interface** that the [<Term id="sequencer">Sequencer</Term>](/docs/how-arbitrum-works/deep-dives/sequencer) uses to store batches of data on the DAS.
...
<VanillaAdmonition type="warning" title="Local Badger database removed">
...
Find information about how to set up a mirror DAS in [How to deploy a mirror DAS](/docs/launch-arbitrum-chain/configuration/data-availability/data-availability-committees/deploy-mirror-das).
