...
1. Soft finality from the [Sequencer](/docs/how-arbitrum-works/deep-dives/sequencer)'s confirmation of <Term id="transaction">transaction</Term> inclusion (~@@l2BlockTimeMs=250@@ms)
