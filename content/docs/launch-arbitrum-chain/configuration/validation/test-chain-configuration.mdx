...
Both read like an interval problem and are not one. Check this before tuning anything. To learn more, see [Parent chain read consistency](/docs/launch-arbitrum-chain/operate/validator-troubleshooting#parent-chain-read-consistency).
