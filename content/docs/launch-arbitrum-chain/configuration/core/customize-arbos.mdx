...
you need to continue to modify [precompile.go](https://github.com/OffchainLabs/<Var name="nitroRepositorySlug" />/blob/<Var name="nitroVersionTag" />/<Var name="nitroPathToPrecompiles" />/precompile.go).
...
After you add a new precompile named `ArbHi` according to the guide in [customize precompile Option 2](/docs/launch-arbitrum-chain/configuration/core/customize-precompile#option-2-create-a-new-precompile) and make changes to [`precompile.go`](https://github.com/OffchainLabs/<Var name="nitroRepositorySlug" />/blob/<Var name="nitroVersionTag" />/<Var name="nitroPathToPrecompiles" />/precompile.go),
