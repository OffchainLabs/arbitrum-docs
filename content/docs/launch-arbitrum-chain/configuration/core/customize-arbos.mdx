...
you need continue to modify [precompile.go](https://github.com/OffchainLabs/{var:nitroRepositorySlug}/blob/{var:nitroVersionTag}/{var:nitroPathToPrecompiles}/precompile.go).
...
After you add a new precompile named `ArbHi` according to the guide in [customize precompile Option 2](./customize-precompile#option-2-create-a-new-precompile) and make changes to [`precompile.go`](https://github.com/OffchainLabs/{var:nitroRepositorySlug}/blob/{var:nitroVersionTag}/{var:nitroPathToPrecompiles}/precompile.go),
...
After you add a new state `myNumber` according to the guide in [customize precompile Option 5](./customize-precompile#option-5-call-and-modify-state), you also need to rewrite [`UpgradeArbosVersion`](https://github.com/OffchainLabs/{var:nitroRepositorySlug}/blob/v3.1.0/{var:nitroPathToArbosState}/arbosstate.go#L253) in [`arbosstate.go`](https://github.com/OffchainLabs/{var:nitroRepositorySlug}/blob/v3.1.0/{var:nitroPathToArbosState}/arbosstate.go):
...
In the above code, we use precompiles as an example. Some logic might also affect the STF, such as the methods in [`block_process.go`](https://github.com/OffchainLabs/{var:nitroRepositorySlug}/blob/{var:nitroVersionTag}/{var:nitroPathToArbos}/block_processor.go), [`internal_tx.go`](https://github.com/OffchainLabs/{var:nitroRepositorySlug}/blob/{var:nitroVersionTag}/{var:nitroPathToArbos}/internal_tx.go), [`tx_processor.go`](https://github.com/OffchainLabs/{var:nitroRepositorySlug}/blob/{var:nitroVersionTag}/{var:nitroPathToArbos}/tx_processor.go) and so on.
...
Please continue reading [Customize STF](./customize-stf#step-3-run-a-local-node) for follow-up operations.
