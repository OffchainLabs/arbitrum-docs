...
Next, follow the steps in [How to customize your Arbitrum chain's behavior](./customize-stf#step-3-run-the-node) to build a modified Arbitrum Nitro node Docker image and run it.
