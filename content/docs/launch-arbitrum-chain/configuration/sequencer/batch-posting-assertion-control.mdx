---
title: 'Configure assertion control'
description: 'Learn how to configure assertion control.'
sidebar_label: 'Assertion control'
user_story:
...
```
   safeBlockThreshold = l1BoundMinBlockNumber + (ReorgResistanceMargin / <Var name="l1SlotTimeSeconds" /> seconds)
