...
To configure [Sequencer](/docs/how-arbitrum-works/deep-dives/sequencer) timing parameters when launching an <a data-quicklook-from="arbitrum-chain">Arbitrum chain</a>, you'll primarily adjust settings in two places:
...
For more on force inclusion and the <a data-quicklook-from="delayed-inbox">Delayed Inbox</a>, see the [Sequencer deep dive](/docs/how-arbitrum-works/deep-dives/sequencer).
