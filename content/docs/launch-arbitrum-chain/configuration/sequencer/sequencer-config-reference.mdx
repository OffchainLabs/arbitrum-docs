...
These apply when you run more than one sequencer with `--node.seq-coordinator.enable=true`. For the deployment, see the [How to set up a high-availability sequencer](/docs/launch-arbitrum-chain/run-a-node/high-availability-sequencer) page.
