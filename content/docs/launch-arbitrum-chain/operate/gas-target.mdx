...
You set the gas target by calling the <Term id="precompile">precompile</Term> `ArbOwner` at address `0x0000000000000000000000000000000000000070`. Only a <Term id="chain-owner">chain owner</Term> can call it. Calls from any other account revert.
