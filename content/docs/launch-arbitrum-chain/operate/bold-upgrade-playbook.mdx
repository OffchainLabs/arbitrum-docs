...
If your chain owner is a single key that can send the upgrade <a data-quicklook-from="transaction">transaction</a> immediately, you do not need this guide—follow the [base guide](/docs/launch-arbitrum-chain/configuration/sequencer/bold-adoption-for-arbitrum-chains) instead.

## The problem this guide solves

The [base guide](/docs/launch-arbitrum-chain/configuration/sequencer/bold-adoption-for-arbitrum-chains) sequence contains two steps that appear to conflict when a security council is involved:
...
The [base guide](/docs/launch-arbitrum-chain/configuration/sequencer/bold-adoption-for-arbitrum-chains) therefore recommends stopping all <a data-quicklook-from="validator">validators</a> at [Step 4](/docs/launch-arbitrum-chain/configuration/sequencer/bold-adoption-for-arbitrum-chains#step-4-gather-the-information-of-the-current-state-of-the-chain) to prevent a new <a data-quicklook-from="confirmation">confirmation</a> from blocking [Step 5](/docs/launch-arbitrum-chain/configuration/sequencer/bold-adoption-for-arbitrum-chains#step-5-run-the-upgrade-script).
...
What `perform` actually requires is narrower than the [base guide](/docs/launch-arbitrum-chain/configuration/sequencer/bold-adoption-for-arbitrum-chains) implies. Confirming another assertion after Step 4 is fine—what matters is that the lookup must contain an entry for whichever assertion is latest-confirmed **at the moment of execution**.
...
To weigh permissioned against <a data-quicklook-from="permissionless-validation">permissionless validation</a>, see [BoLD for Arbitrum chains](/docs/launch-arbitrum-chain/configuration/sequencer/bold-adoption-for-arbitrum-chains#caveats-that-come-with-adopting-arbitrum-bold-for-permissionless-validation). It covers bond sizing and resource exhaustion risk.
