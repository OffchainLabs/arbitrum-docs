...
If your chain owner is a single key that can send the upgrade <Term id="transaction">transaction</Term> immediately, you do not need this guide—follow the [base guide](/docs/launch-arbitrum-chain/configuration/sequencer/bold-adoption-for-arbitrum-chains) instead.
...
- **Step 5** executes the upgrade, and reverts if a new <Term id="assertion">assertion</Term> has been confirmed since Step 4.
