...
<Callout type="warning" title="ArbOS upgrades are one-way">
...
<Callout type="info" title="Why the consensus tag matters">
...
See [Ownership and access](/docs/launch-arbitrum-chain/operate/ownership-and-access) to confirm which account holds which role.
...
<Callout type="idea" title="WASM module roots are backward compatible">
...
<Callout type="warning" title="The Dockerfile only downloads recent machines">
...
If you maintain a custom STF, downloading a published machine is not sufficient—see [Customize your chain's behavior](/docs/launch-arbitrum-chain/extend-the-protocol/stf) to learn how to build and register your own.
...
<Callout type="warning" title="Stage machines and restart before you set the root onchain">
...
<Callout type="warning" title="Upgrade nodes before the activation timestamp">
...
If your chain has <Term id="fast-withdrawals">fast withdrawals</Term> enabled, re-check them specifically after the upgrade—see [Fast withdrawals](/docs/launch-arbitrum-chain/chain-config/validation/fast-withdrawals).
...
<Callout type="warning" title="Clearing `pending-upgrade-module-root` is not a fix for a Rollup mismatch">
...
<Callout type="warning" title="Don't suppress the mismatch check">
...
<Callout type="warning" title="Reverting contracts after assertions exist">
...
- [Ownership and access](/docs/launch-arbitrum-chain/operate/ownership-and-access)—which account holds which administrative role
- [Monitoring tools and considerations](/docs/launch-arbitrum-chain/operate/monitoring)—what to watch during and after an upgrade
- [Batch poster troubleshooting](/docs/launch-arbitrum-chain/operate/batch-poster-troubleshooting)—diagnosing batch poster errors
- [Customize your chain's behavior](/docs/launch-arbitrum-chain/extend-the-protocol/stf)—building a custom STF and its replay binary
