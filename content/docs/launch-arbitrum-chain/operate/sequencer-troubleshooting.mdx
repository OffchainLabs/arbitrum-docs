...
<Callout type="info" title="Defaults in this guide">
...
<Callout type="warning" title="A growing feed backlog is not a lagging follower">
...
<Callout type="warning" title="Redundant feed connections">
...
<Callout type="warning" title="This check only runs with a parent chain reader">
...
For the surplus flags, see [Sequencer configuration reference](/docs/launch-arbitrum-chain/chain-config/sequencer/sequencer-config-reference#expected-surplus-flags).
...
- **A batch posting backlog.** The sequencer keeps producing blocks while unposted batches accumulate. See [Batch poster troubleshooting](/docs/launch-arbitrum-chain/operate/batch-poster-troubleshooting).
