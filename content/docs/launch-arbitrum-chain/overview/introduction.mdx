...
That economic model is the core reason to choose Arbitrum: your business captures the fee revenue and priority-access value that L1s hand off to validators, because costs scale with usage ([gas targets](/docs/launch-arbitrum-chain/chain-config/costs/dynamic-pricing#how-to-set-multiple-gas-targets)) rather than set (fixed) fees. You also control the economics directly—[custom gas tokens](/docs/launch-arbitrum-chain/chain-config/costs/custom-gas-token-rollup), [fee policy](/docs/launch-arbitrum-chain/chain-config/costs/fee-management), and revenue capture—while getting institution-grade settlement: sub-second soft finality for a responsive user experience, [configurable hard finality on Ethereum in minutes](/docs/launch-arbitrum-chain/chain-config/sequencer/chain-finality), and [native withdrawals in as little as 15 minutes](/docs/launch-arbitrum-chain/chain-config/validation/fast-withdrawals), backed by a clean, externally legible counterparty-risk story for your risk, audit, and compliance stakeholders.

Beyond economics, an Arbitrum chain lets you launch fast and customize deeply. You get day-one configuration over high, fully tunable throughput and [block times (as low as 100ms)](/docs/launch-arbitrum-chain/chain-config/sequencer/sequencer-timing-adjustments), [data availability (Rollup, AnyTrust, or external DA)](/docs/launch-arbitrum-chain/chain-config/data-availability/config-data-availability), [sequencing and MEV rules](/docs/how-arbitrum-works/timeboost/gentle-introduction), KYC/AML and permissioning, privacy, [precompiles](/docs/launch-arbitrum-chain/extend-the-protocol/precompiles), governance, and multi-prover settlement—and you automatically inherit every future Ethereum and Arbitrum upgrade, including [Stylus](/docs/stylus/gentle-introduction), without custom engineering.

Critically, your chain isn't siloed: it plugs directly into Ethereum's deep liquidity and the broader Arbitrum ecosystem. And you can de-risk your go-to-market with a phased ["launch-and-migrate" path](/docs/launch-arbitrum-chain/migrate/from-another-stack)—prove your product on the shared, liquid <Term id="arbitrum-one">Arbitrum One</Term>, then graduate to your own dedicated Arbitrum chain as a seamless continuation on the same stack, not a costly replatforming.
...
- **Guides**
  - [Configure chain finality](/docs/launch-arbitrum-chain/chain-config/sequencer/chain-finality)
  - [Sequencer timing adjustments](/docs/launch-arbitrum-chain/chain-config/sequencer/sequencer-timing-adjustments)
...
- **Guide**
  - [Fast withdrawals](/docs/launch-arbitrum-chain/chain-config/validation/fast-withdrawals)
...
- **Guides**
  - [Custom gas token (Rollup)](/docs/launch-arbitrum-chain/chain-config/costs/custom-gas-token-rollup)
  - [Custom gas token (AnyTrust)](/docs/launch-arbitrum-chain/chain-config/costs/custom-gas-token-anytrust)
...
- **Guide**
  - [Fee management](/docs/launch-arbitrum-chain/chain-config/costs/fee-management)
...
- **Guide**
  - [Native mint and burn](/docs/launch-arbitrum-chain/chain-config/costs/configure-native-mint-burn)
...
- **Guide**
  - [Dynamic pricing](/docs/launch-arbitrum-chain/chain-config/costs/dynamic-pricing)
...
- **Guide**
  - [Manage gas target](/docs/launch-arbitrum-chain/chain-config/costs/gas-target)
...
- **Guides**
  - [Gas target guidance](/docs/launch-arbitrum-chain/chain-config/costs/gas-target)
  - [Gas optimization](/docs/launch-arbitrum-chain/chain-config/costs/gas-optimization#block-gas-limit)
...
- **Guide**
  - [Validation and BoLD](/docs/launch-arbitrum-chain/chain-config/validation/bold)
...
- **Guide**
  - [Configure data availability](/docs/launch-arbitrum-chain/chain-config/data-availability/config-data-availability)
...
<Callout type="info">These controls apply at the validator and data-availability layers—who validates the chain and who can read its data. They are not a per-user transaction allowlist; screening which end users may submit transactions is an application-layer concern, not a chain-config setting.</Callout>
...
- **Guide**
  - [Timeboost configuration](/docs/launch-arbitrum-chain/chain-config/sequencer/timeboost)
...
- **Guide**
  - [Ownership and access control](/docs/launch-arbitrum-chain/operate/ownership-and-access)
...
- **Guides**
  - [Delayed inbox](/docs/launch-arbitrum-chain/chain-config/sequencer/chain-finality)
  - [Fast withdrawals](/docs/launch-arbitrum-chain/chain-config/validation/fast-withdrawals)
  - [Challenge period](/docs/launch-arbitrum-chain/chain-config/validation/challenge-period)
...
- **Guides**
  - [Dynamic pricing](/docs/launch-arbitrum-chain/chain-config/costs/dynamic-pricing)
  - [Fee management](/docs/launch-arbitrum-chain/chain-config/costs/fee-management)
  - [Gas optimization](/docs/launch-arbitrum-chain/chain-config/costs/gas-optimization)
  - [Batch poster fee tuning](/docs/launch-arbitrum-chain/chain-config/batch-poster/fee-tuning)
...
- [Compliance filtering](/docs/launch-arbitrum-chain/chain-config/sequencer/compliance-filtering)
