...
{/* prettier-ignore */}
<a data-quicklook-from="arbitrum-chains">Arbitrum chains</a> give you flexibility and control without the constraint of running your own <a data-quicklook-from="layer-1-l1">Layer 1</a> blockchain. Instead of bootstrapping and subsidizing your own <a data-quicklook-from="validator">validator</a> set, your chain [anchors its security and finality to Ethereum](/docs/how-arbitrum-works/deep-dives/transaction-lifecycle), turning security into a variable, usage-based expense.

That economic model is the core reason to choose Arbitrum: your business captures the fee revenue and priority-access value that L1s hand off to validators, because costs scale with usage ([gas targets](/docs/launch-arbitrum-chain/configuration/costs/dynamic-pricing-for-arbitrum-chains#how-to-set-multiple-gas-targets)) rather than set (fixed) fees. You also control the economics directly—[custom gas tokens](/docs/launch-arbitrum-chain/configuration/costs/use-a-custom-gas-token-rollup), [fee policy](/docs/launch-arbitrum-chain/configuration/costs/fee-management), and revenue capture—while getting institution-grade settlement: sub-second soft finality for a responsive user experience, [configurable hard finality on Ethereum in minutes](/docs/launch-arbitrum-chain/configuration/validation/arbitrum-chain-finality), and [native withdrawals in as little as 15 minutes](/docs/launch-arbitrum-chain/configuration/validation/fast-withdrawals), backed by a clean, externally legible counterparty-risk story for your risk, audit, and compliance stakeholders.

Beyond economics, an Arbitrum chain lets you launch fast and customize deeply. You get day-one configuration over high, fully tunable throughput and [block times (as low as 100ms)](/docs/launch-arbitrum-chain/configuration/sequencer/config-sequencer-timing-adjustments), [data availability (Rollup, AnyTrust, or external DA)](/docs/launch-arbitrum-chain/configuration/data-availability/config-data-availability), [sequencing and MEV rules](/docs/how-arbitrum-works/timeboost/gentle-introduction), KYC/AML and permissioning, privacy, [precompiles](/docs/launch-arbitrum-chain/configuration/core/customize-precompile), governance, and multi-prover settlement—and you automatically inherit every future Ethereum and Arbitrum upgrade, including [Stylus](/docs/stylus/gentle-introduction), without custom engineering.

Critically, your chain isn't siloed: it plugs directly into Ethereum's deep liquidity and the broader Arbitrum ecosystem. And you can de-risk your go-to-market with a phased ["launch-and-migrate" path](/docs/launch-arbitrum-chain/migrate/migrate-from-another-stack)—prove your product on the shared, liquid <a data-quicklook-from="arbitrum-one">Arbitrum One</a>, then graduate to your own dedicated Arbitrum chain as a seamless continuation on the same stack, not a costly replatforming.
...
- **Guides**
  - [Configure chain finality](/docs/launch-arbitrum-chain/configuration/validation/arbitrum-chain-finality)
  - [Sequencer timing adjustments](/docs/launch-arbitrum-chain/configuration/sequencer/config-sequencer-timing-adjustments)
...
- **Guide**
  - [Fast withdrawals](/docs/launch-arbitrum-chain/configuration/validation/fast-withdrawals)
...
- **Guides**
  - [Custom gas token (Rollup)](/docs/launch-arbitrum-chain/configuration/costs/use-a-custom-gas-token-rollup)
  - [Custom gas token (AnyTrust)](/docs/launch-arbitrum-chain/configuration/costs/use-a-custom-gas-token-anytrust)
...
- **Guide**
  - [Fee management](/docs/launch-arbitrum-chain/configuration/costs/fee-management)
...
- **Guide**
  - [Native mint and burn](/docs/launch-arbitrum-chain/configuration/costs/configure-native-mint-burn-gas-token)
...
- **Guide**
  - [Dynamic pricing](/docs/launch-arbitrum-chain/configuration/costs/dynamic-pricing-for-arbitrum-chains)
...
- **Guide**
  - [Manage gas target](/docs/launch-arbitrum-chain/operate/gas-target)
...
- **Guides**
  - [Gas target guidance](/docs/launch-arbitrum-chain/operate/gas-target)
  - [Gas optimization](/docs/launch-arbitrum-chain/configuration/costs/gas-optimization-tools#block-gas-limit)
...
- **Guide**
  - [Validation and BoLD](/docs/launch-arbitrum-chain/configuration/sequencer/bold-adoption-for-arbitrum-chains)
...
- **Guide**
  - [Configure data availability](/docs/launch-arbitrum-chain/configuration/data-availability/config-data-availability)
...
- **Guide**
  - [How the Sequencer works](/docs/how-arbitrum-works/deep-dives/sequencer)
...
- **Guide**
  - [Timeboost configuration](/docs/launch-arbitrum-chain/configuration/sequencer/timeboost-for-arbitrum-chains)
...
- **Guide**
  - [Ownership and access control](/docs/launch-arbitrum-chain/operate/ownership-access-control)
...
- **Guides**
  - [Delayed inbox](/docs/launch-arbitrum-chain/configuration/validation/arbitrum-chain-finality)
  - [Fast withdrawals](/docs/launch-arbitrum-chain/configuration/validation/fast-withdrawals)
  - [Challenge period](/docs/launch-arbitrum-chain/configuration/validation/customizable-challenge-period)
...
- **Guides**
  - [Dynamic pricing](/docs/launch-arbitrum-chain/configuration/costs/dynamic-pricing-for-arbitrum-chains)
  - [Fee management](/docs/launch-arbitrum-chain/configuration/costs/fee-management)
  - [Gas optimization](/docs/launch-arbitrum-chain/configuration/costs/gas-optimization-tools)
  - [Batch poster fee tuning](/docs/launch-arbitrum-chain/configuration/sequencer/batch-poster-fee-tuning)
...
- [Stylus gentle intro](/docs/stylus/gentle-introduction)
- [Deploy non-Rust WASM contracts](/docs/stylus/how-tos/deploying-non-rust-wasm-contracts)
...
- [Compliance filtering](/docs/launch-arbitrum-chain/configuration/sequencer/compliance-filtering)
...
- **Guide**
  - [CLI flags reference](/docs/run-a-node/nitro/cli-flags-reference)
