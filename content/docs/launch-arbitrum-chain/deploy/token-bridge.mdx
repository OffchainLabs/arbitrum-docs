...
Once you have deployed your Arbitrum chain and have a node running, you can deploy a token bridge for your chain. See the [Overview](/docs/launch-arbitrum-chain/quickstart/sdk-introduction) for an introduction to creating and configuring an Arbitrum chain.

Before reading this guide, we recommend:

- Becoming familiar with the general process of creating new chains explained in [How to deploy an Arbitrum chain](/docs/launch-arbitrum-chain/deploy/deploy-chain)
...
If you hit a problem while deploying, verifying, or registering token bridge contracts, see [Token bridge troubleshooting](/docs/launch-arbitrum-chain/deploy/token-bridge-troubleshooting).
...
<Callout type="warning" title="You must verify Arbitrum chain contracts' source code">
