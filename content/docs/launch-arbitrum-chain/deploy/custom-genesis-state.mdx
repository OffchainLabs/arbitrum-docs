...
<VanillaAdmonition type="warning" title="Generate the genesis before deploying the chain">
...
<VanillaAdmonition type="warning" title="Preserve the generated chain configuration and base fee">
