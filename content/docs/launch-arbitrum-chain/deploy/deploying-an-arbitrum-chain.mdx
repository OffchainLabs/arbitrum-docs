...
| `maxDataSize`               | `uint256`   | Maximum message size for the Inbox contract (`@@maxDataSizeL2=117964@@` for <Term id="L2">L2</Term> chains, and `@@maxDataSizeL3=104857@@` for L3 chains).                                                                                                                                                                                               |
