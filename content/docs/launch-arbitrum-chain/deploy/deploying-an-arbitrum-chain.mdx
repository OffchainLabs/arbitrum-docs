...
| `maxDataSize`               | uint256   | Maximum message size for the Inbox contract (<code><Var name="maxDataSizeL2" /></code> for L2 chains, and <code><Var name="maxDataSizeL3" /></code> for L3 chains).                                                                                                                                             |
