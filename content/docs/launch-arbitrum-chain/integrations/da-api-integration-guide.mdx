...
- **Fraud-proof compatible**: Full support for [BoLD](/docs/how-arbitrum-works/bold/gentle-introduction) <a data-quicklook-from="challenge">challenge</a> protocol and fraud proofs
...
- **Normal execution**: [Batch Poster](/docs/how-arbitrum-works/deep-dives/assertions) stores data -> generates certificate -> posts to <a data-quicklook-from="L1">L1</a>
