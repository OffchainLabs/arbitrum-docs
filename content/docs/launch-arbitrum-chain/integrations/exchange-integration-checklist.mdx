...
<Callout type="warning" title="Re-verify on every upgrade">
...
<Callout type="warning" title="Run an archive or debug-capable node">
...
<Callout type="info" title="Calldata here means transaction input, not batch data availability">
...
<Callout type="info" title="Arbitrum block timing">
...
<Callout type="warning" title="Arbitrum-specific deposits to watch">
...
<Callout type="warning" title="Finality on Dedicated Blockchains">
...
<Callout type="info" title="For Dedicated Blockchain owners">
