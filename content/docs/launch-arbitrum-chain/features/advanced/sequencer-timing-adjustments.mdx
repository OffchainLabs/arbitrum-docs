...
For information on how to configure the Sequencer timing, refer to the [Sequencer Timing Adjustments configuration](/docs/launch-arbitrum-chain/configuration/sequencer/config-sequencer-timing-adjustments) page.
