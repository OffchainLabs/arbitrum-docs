...
It is important to understand that this is part of customizing the behavior of your chain. You can read more about this on the [Choose Custom Behavior](/docs/launch-arbitrum-chain/features/advanced/choose-custom-behavior) page.
