...
To enable blob <Term id="transaction">transaction</Term> posting, add the following configuration to your [Batch Poster](/docs/how-arbitrum-works/deep-dives/assertions) node:
