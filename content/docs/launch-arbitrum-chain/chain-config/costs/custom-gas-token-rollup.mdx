...
3. Configure the fee token and pricer when creating the rollup
   ...
   - `STAKE_TOKEN_ADDRESS` = token used for bonding (see [BoLD docs](/docs/launch-arbitrum-chain/chain-config/validation/bold#use-of-your-projects-native-token-as-the-bonding-asset-to-secure-the-chain) for more details)
...
You can also find more info about how Nitro manages [gas and fees](/docs/how-arbitrum-works/deep-dives/gas-and-fees) here. If you’re unsure how to configure the Rollup correctly or have questions about fee pricer implementations, please get in touch with <Term id="offchain-labs">Offchain Labs</Term> or your chain’s deployment provider.
