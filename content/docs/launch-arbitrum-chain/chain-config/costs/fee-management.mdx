...
- **Parent chain surplus fee**: if configured, these are extra fees rewarded to the [Batch Poster](/docs/how-arbitrum-works/deep-dives/assertions).

You can find more detailed information about these fee types in these pages:

- [L2 fees](/docs/how-arbitrum-works/deep-dives/gas-and-fees#child-chain-gas-pricing) for the Arbitrum chain base fee and surplus fee
- [L1 fees](/docs/how-arbitrum-works/deep-dives/gas-and-fees#parent-chain-gas-pricing) for the Parent chain base fee and surplus fee
...
<Callout type="info" title="Arbitrum chain surplus fees are automatically adjusted">
...
<Callout type="info" title="Parent chain base fees are automatically adjusted">
...
<Callout type="info" title="Parent chain base fee configuration for chains using a custom gas token">
...
The [`ArbOwner`](/docs/arbitrum-essentials/precompiles/reference#arbowner) precompile also has a `getInfraFeeAccount()(address)` method that can be used, but only by the owner of the chain.
...
The [`ArbOwner`](/docs/arbitrum-essentials/precompiles/reference#arbowner) precompile also has a `getNetworkFeeAccount()(address)` method that can be used, but only by the owner of the chain.
...
<Callout type="info" title="Example scripts available in the Chain SDK">
