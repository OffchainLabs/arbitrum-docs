...
While certain restrictions are in place today (see above), some of them may be removed in upcoming releases of the custom gas token feature. Please reach out to the <Term id="offchain-labs">Offchain Labs</Term> team with any questions or requests for additions to the custom gas token feature.
...
These methods use <Term id="L1">L1</Term> to refer to the parent chain of the Arbitrum chain.
