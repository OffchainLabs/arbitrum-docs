...
| `DataAvailabilityCommittee` | `false`  | `false` = Rollup (L1 data posting); `true` = AnyTrust ([DAC](/docs/launch-arbitrum-chain/chain-config/data-availability/dac-get-started)) |
...
<Callout type="warning" title="For informational purposes only">
