...
Reorg prevention interacts with batch posting through `maxTimeVariation` and `reorg-resistance-margin`. See the [Configure Sequencer timing adjustments](/docs/launch-arbitrum-chain/chain-config/sequencer/sequencer-timing-adjustments) page for the full mechanism.
