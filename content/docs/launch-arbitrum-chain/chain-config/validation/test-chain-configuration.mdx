...
<Callout type="warning" title="These values are unsafe for production">
...
<Callout type="info" title="This is not the same as fast withdrawals">
...
<Callout type="info" title="BoLD has no equivalent preset">
