...
For the full set of coordinator flags and their defaults, see [Sequencer configuration reference](/docs/launch-arbitrum-chain/chain-config/sequencer/sequencer-config-reference#sequencer-coordinator-flags).
