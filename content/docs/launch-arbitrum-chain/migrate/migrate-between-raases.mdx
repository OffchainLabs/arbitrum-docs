...
<Term id="sequencer">Sequencer</Term> runtime, batch poster, bonder/validators, DAC signer set for AnyTrust, RPC/explorer domains, alerting/monitoring credentials. Your RaaS may have other requirements.
...
Retryables creation, batch posting cadence, <Term id="assertion">Assertion</Term> <Term id="confirmation">Confirmation</Term>, base fee, sequencer health, DAC signer liveness. Please see '[Monitoring Tools and Considerations](https://docs.arbitrum.io/launch-arbitrum-chain/maintain-your-chain/monitoring-tools-and-considerations)’ for more information.
