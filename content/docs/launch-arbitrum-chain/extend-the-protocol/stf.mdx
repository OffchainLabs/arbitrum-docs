...
Next, make your changes to the State Transition Function. For example, you could [add a custom precompile](/docs/launch-arbitrum-chain/extend-the-protocol/precompiles).

After this step, you should visit [Customize ArbOS version](/docs/launch-arbitrum-chain/extend-the-protocol/arbos) to see if your changes need to upgrade the ArbOS version. If so, please continue to
