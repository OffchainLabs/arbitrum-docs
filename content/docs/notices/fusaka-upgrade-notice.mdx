...
Arbitrum chain operators must ensure that their nodes are properly configured before or shortly after the parent chain upgrades to Fusaka or the child chain upgrades to [ArbOS 51](/run-arbitrum-node/arbos-releases/arbos51.mdx).
...
| `Dec 1st 2025, 17:00:00 UTC`  | Arbitrum Sepolia upgrade to [ArbOS 51](/run-arbitrum-node/arbos-releases/arbos51.mdx)  | Node operators for Arbitrum Sepolia                                                               |
| `Jan 8th, 2026, 17:00:00 UTC` | Arbitrum One/Nova upgrade to [ArbOS 51](/run-arbitrum-node/arbos-releases/arbos51.mdx) | Node operators for Arbitrum One/Nova                                                              |
