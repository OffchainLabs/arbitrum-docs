...
This section details how [<a data-quicklook-from="stylus">Stylus</a>](/docs/stylus/gentle-introduction) integrates into the [<a data-quicklook-from="state-transition-function">State Transition Function</a> (STF)](/how-arbitrum-works/deep-dives/stf.mdx), covering execution flow, message handling, caching, and interactions with [<a data-quicklook-from="arbos">ArbOS</a>](/docs/how-arbitrum-works/deep-dives/arbos) and [<a data-quicklook-from="geth">Geth</a>](/docs/how-arbitrum-works/reference/geth).
