...
This section details how [<Term id="stylus">Stylus</Term>](/docs/stylus/gentle-introduction) integrates into the [<Term id="state-transition-function">State Transition Function</Term> (STF)](/how-arbitrum-works/deep-dives/stf.mdx), covering execution flow, message handling, caching, and interactions with [<Term id="arbos">ArbOS</Term>](/docs/how-arbitrum-works/deep-dives/arbos) and [<Term id="geth">Geth</Term>](/docs/how-arbitrum-works/reference/geth).
