...
Independently, the [batch poster](/docs/how-arbitrum-works/deep-dives/batchposter) compresses the sequenced transactions and posts them to the sequencer inbox on the parent chain, at which point they inherit the parent chain's finality. Validators then re-execute the posted sequence and assert the resulting state. [The Sequencer and censorship resistance](/docs/how-arbitrum-works/deep-dives/sequencer#4-persistence-and-broadcast) covers the feed, batch posting, and the finality trade-offs in detail, and [Assertions](/docs/how-arbitrum-works/deep-dives/assertions) covers validation.
...
- [The Sequencer and censorship resistance](/docs/how-arbitrum-works/deep-dives/sequencer): feed, batch posting, finality, and the delayed inbox escape hatch
- [Finality](/docs/how-arbitrum-works/deep-dives/finality): what soft and hard finality guarantee, and which one to wait for
...
- [How to set up a high-availability sequencer](/docs/launch-arbitrum-chain/run-a-node/high-availability-sequencer): redundant Sequencers with Redis-based coordination
