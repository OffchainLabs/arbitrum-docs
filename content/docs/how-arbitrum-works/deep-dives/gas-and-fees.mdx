...
The child chain component consists of the traditional fees <Term id="geth">Geth</Term> would pay to bonders in a vanilla parent chain, such as the computation and storage charges that apply to the [<Term id="state-transition-function">State Transition Function</Term> (STF)](/how-arbitrum-works/deep-dives/stf.mdx). [<Term id="arbos">ArbOS</Term>](/docs/how-arbitrum-works/deep-dives/arbos) charges additional fees for executing its child-chain-specific [precompiles](/docs/arbitrum-essentials/precompiles/overview), whose fees are dynamically priced based on the resources used during execution.
