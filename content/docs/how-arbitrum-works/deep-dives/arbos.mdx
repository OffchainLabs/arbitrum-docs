...
- `sendMerkle` is the accumulator that records every L2 → L1 message; its root is what the parent-chain <Term id="outbox">Outbox</Term> verifies against when a withdrawal is finalized.
