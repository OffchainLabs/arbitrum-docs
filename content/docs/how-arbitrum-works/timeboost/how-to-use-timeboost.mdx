...
| `SEQUENCE_NUMBER_TOO_LOW` | the sequencer number used for the given transaction is numerically lower than the expected sequence number, try resubmitting with the expected sequence number |
