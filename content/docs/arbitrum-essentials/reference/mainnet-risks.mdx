...
description: 'Understand the risks of deploying on Arbitrum mainnet, including the state of progressive decentralization, smart contract upgrade mechanisms, and trust assumptions for Arbitrum One and Nova.'
user_story: 'As a developer, I want to understand the risks of using Arbitrum mainnet so I can make informed decisions about deploying my application.'
content_type: 'concept'
author: dzgoldman
sme: dzgoldman
---

Arbitrum One is the first permissionless Ethereum parent chain rollup with full Ethereum smart contract functionality, and is [live on mainnet](https://offchain.medium.com/mainnet-for-everyone-27ce0f67c85e) — as is [Nova](https://medium.com/offchainlabs/its-time-for-a-new-dawn-nova-is-open-to-the-public-a081df1e4ad2), our first [AnyTrust chain](/docs/how-arbitrum-works/deep-dives/anytrust-protocol); We're sure you're (almost) as excited as we are!
