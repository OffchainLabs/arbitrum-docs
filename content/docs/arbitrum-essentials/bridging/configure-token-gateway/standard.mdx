...
For architectural details, see [Standard **ERC-20** bridging](/docs/how-arbitrum-works/deep-dives/token-bridging#default-standard-bridging).
...
- [Standard **ERC-20** bridging details](/docs/how-arbitrum-works/deep-dives/token-bridging#default-standard-bridging)
