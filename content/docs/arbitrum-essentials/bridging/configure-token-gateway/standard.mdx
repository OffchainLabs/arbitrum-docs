...
- [Generic-custom gateway](/docs/arbitrum-essentials/bridging/configure-token-gateway/generic-custom)—for custom child chain token logic
- [Custom gateway](/docs/arbitrum-essentials/bridging/configure-token-gateway/custom)—for advanced use cases

## Prerequisites

- A standard **ERC-20** token deployed on the parent chain (or deploy one following this guide)
- Familiarity with [Arbitrum's token bridge system](/docs/how-arbitrum-works/deep-dives/token-bridging)
...
For architectural details, see [Standard **ERC-20** bridging](/docs/how-arbitrum-works/deep-dives/token-bridging#the-standard-erc-20-gateway).
...
You can find contract addresses on the [contract addresses page](/docs/arbitrum-essentials/reference/contract-addresses#token-bridge-smart-contracts).
...
For complete deposit instructions, see [Deposit tokens](/docs/arbitrum-essentials/bridging/deposit/tokens).
...
For these cases, use a [generic-custom gateway](/docs/arbitrum-essentials/bridging/configure-token-gateway/generic-custom) or a [custom gateway](/docs/arbitrum-essentials/bridging/configure-token-gateway/custom).
...
- [Deposit tokens](/docs/arbitrum-essentials/bridging/deposit/tokens)
- [Withdraw tokens](/docs/arbitrum-essentials/bridging/withdraw/tokens)
...
- [Token bridge conceptual overview](/docs/how-arbitrum-works/deep-dives/token-bridging)
- [Standard **ERC-20** bridging details](/docs/how-arbitrum-works/deep-dives/token-bridging#the-standard-erc-20-gateway)
