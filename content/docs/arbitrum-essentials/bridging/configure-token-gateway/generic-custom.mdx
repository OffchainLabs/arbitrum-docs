...
For an example of bridging a token from the parent to the child chain using Arbitrum's SDK, check out [How to bridge tokens via Arbitrum's standard **ERC-20** gateway](/arbitrum-essentials/bridging/deposit/tokens.mdx), specifically Steps 2-5.
