...
Retryable tickets are Arbitrum's canonical mechanism for reliable <Term id="crosschain-message">cross-chain message</Term> delivery. They automatically retry failed executions.
