...
Retryable tickets are Arbitrum's canonical mechanism for reliable <a data-quicklook-from="crosschain-message">cross-chain message</a> delivery. They automatically retry failed executions.
...
- For bridging tokens programmatically, see [Bridge tokens programmatically](/arbitrum-essentials/bridging/overview.mdx)
