...
- These APIs are only needed for [`custom gas token`](/docs/launch-arbitrum-chain/configuration/costs/use-a-custom-gas-token-rollup) <a data-quicklook-from="arbitrum-chains">Arbitrum Chains</a>. For **ETH**-powered rollup and AnyTrust Arbitrum chains, you don't need to use them.
