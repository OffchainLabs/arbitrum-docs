...
- These APIs are only needed for [`custom gas token`](/docs/launch-arbitrum-chain/configuration/costs/use-a-custom-gas-token-rollup) <Term id="arbitrum-chains">Arbitrum Chains</Term>. For **ETH**-powered rollup and AnyTrust Arbitrum chains, you don't need to use them.
