...
- [Contracts](/docs/stylus/fundamentals/contracts): High-level contract development
- [Global Variables](/docs/stylus/fundamentals/global-variables-and-functions): VM context methods
