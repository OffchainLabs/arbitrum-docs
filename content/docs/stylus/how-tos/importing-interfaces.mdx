...
![Call Decision Tree](/img/stylus-call-decision-tree.png)

_Figure 2: Decision tree for selecting the appropriate Call constructor based on state modification and payment requirements._
...
- [Stylus contracts reference](/docs/stylus/fundamentals/contracts#external-contract-calls): Detailed reference for external contract calls
