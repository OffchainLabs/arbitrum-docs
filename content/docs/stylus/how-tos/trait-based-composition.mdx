...
<VanillaAdmonition type="warning" title="For Solidity developers">
...
<VanillaAdmonition type="warning" title="No explicit override keywords">
...
<VanillaAdmonition type="warning" title="Selector precision">
