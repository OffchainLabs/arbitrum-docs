...
The [`sol_interface!`](https://docs.rs/stylus-sdk/latest/stylus_sdk/prelude/macro.sol_interface.html) macro defines a `struct` for each of the Solidity interfaces provided.
...
[`transfer_eth`](https://docs.rs/stylus-sdk/latest/stylus_sdk/call/fn.transfer_eth.html) provides a convenient shorthand for transferring ether.
