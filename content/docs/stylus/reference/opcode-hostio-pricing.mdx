...
This reference provides the latest gas and ink costs for specific WASM opcodes and host I/Os when using Stylus. For a conceptual introduction to Stylus gas and ink, see [Gas and ink (Stylus)](/docs/stylus/concepts/gas-metering).
...
- [Gas and ink (Stylus)](/docs/stylus/concepts/gas-metering): A conceptual introduction to the "gas" and "ink" primitives
