...
- An empty tuple `()` represents no return value
...
- [Primitives](/docs/stylus/fundamentals/data-types/primitives): Basic types (bool, integers, address, strings)
- [Storage Types](/docs/stylus/fundamentals/data-types/storage): Persistent storage for compound types
