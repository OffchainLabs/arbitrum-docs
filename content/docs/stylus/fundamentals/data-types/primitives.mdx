...
- For storage, use `StorageString` (see [Storage Types](/docs/stylus/fundamentals/data-types/storage))
...
- [Compound Types](/docs/stylus/fundamentals/data-types/compound-types) - Arrays, tuples, structs
- [Storage Types](/docs/stylus/fundamentals/data-types/storage) - Persistent storage for primitives
