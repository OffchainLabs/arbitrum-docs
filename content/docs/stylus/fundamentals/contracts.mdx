...
Stylus smart contracts are fully compatible with Solidity contracts on Arbitrum chains. They compile to WebAssembly and share the same EVM state trie as Solidity contracts, enabling interoperability.
...
See the [Global Variables and Functions](/docs/stylus/fundamentals/global-variables-and-functions) documentation for a complete list of available VM methods.

## Events

Events allow contracts to log data to the blockchain, enabling offchain monitoring and indexing.
...
- [Primitives](/docs/stylus/fundamentals/data-types/primitives): Basic data types
- [Compound Types](/docs/stylus/fundamentals/data-types/compound-types): Arrays, structs, tuples
- [Storage Types](/docs/stylus/fundamentals/data-types/storage): Persistent storage
- [Global Variables and Functions](/docs/stylus/fundamentals/global-variables-and-functions): VM context methods
- [Minimal entrypoint contracts](/docs/stylus/advanced/minimal-entrypoint-contracts): Hand-craft an entrypoint without macros
