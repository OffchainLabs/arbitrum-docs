...
- If the Arbitrum chain posts <Term id="blob">blobs</Term> to a Fusaka-enabled <Term id="parent-chain">Parent chain</Term>, ensure that the consensus layer client is configured correctly as per the [Fusaka upgrade notice](/docs/notices/fusaka-upgrade-notice).
