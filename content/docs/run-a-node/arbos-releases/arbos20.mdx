...
To enable the posting of transaction data in Blobs to L1 Ethereum, please refer to the [Enable post-4844 blobs](/docs/launch-arbitrum-chain/configuration/batch-poster/enable-4844-blobs) section of the Arbitrum chain configuration guide.
