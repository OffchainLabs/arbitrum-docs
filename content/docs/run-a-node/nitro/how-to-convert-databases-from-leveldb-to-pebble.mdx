...
For background on how the database backend interacts with Nitro's caches and memory usage, see [Nitro memory management](/docs/run-a-node/nitro/nitro-memory-management).
