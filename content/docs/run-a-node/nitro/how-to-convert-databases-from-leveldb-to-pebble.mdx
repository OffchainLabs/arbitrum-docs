...
For background on how the database backend interacts with Nitro's caches and memory usage, see [node tuning and monitoring](/docs/run-a-node/nitro/node-tuning-and-monitoring).
