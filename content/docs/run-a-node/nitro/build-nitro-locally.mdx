...
Docker publishes install guides for [Debian](https://docs.docker.com/engine/install/debian) and [Ubuntu](https://docs.docker.com/engine/install/ubuntu). To install it from the command line, run:
...
Install Node.js 24 with [nvm](https://github.com/nvm-sh/nvm).
...
Install Bison 3.8.2 from the [GNU Bison project](https://savannah.gnu.org/projects/bison/).
...
Install Go 1.25 with [gvm](https://github.com/moovweb/gvm).
