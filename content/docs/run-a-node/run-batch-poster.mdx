...
To learn how the <Term id="batch-poster">batch-poster</Term> role relates to the other Nitro node roles, including its wallet requirements and the safety rules for running redundant posters, see [How to assign roles to a Nitro node](/docs/run-a-node/assign-node-roles).
...
| ----------------------------------------------------- | ------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `--node.batch-poster.enable`                          | false         | Enables posting batches to <Term id="L1">L1</Term>                                                                                                                                                              |
