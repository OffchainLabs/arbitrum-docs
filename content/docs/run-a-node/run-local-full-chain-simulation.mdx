...
You'll need the `release` branch of the [nitro-testnode](https://github.com/OffchainLabs/nitro-testnode) repo.
...
<VanillaAdmonition type="warning" title="Private keys publicly known">
