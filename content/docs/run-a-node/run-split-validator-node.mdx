...
Before you read this doc, please ensure you have already walked through [run a validator](/docs/run-a-node/more-types/run-validator-node) docs to understand the basics of a validator node.
