...
<Callout type="info" title="Arbitrum Nova and Sepolia">
...
- Latest Docker Image: <code>offchainlabs/arb-node:v1.4.6-551a39b3</code>
- Latest classic snapshot for Arbitrum One: [<Var name="arbOneClassicArchiveSnapshot" />](https://snapshot.arbitrum.foundation/arb1/classic-archive.tar)
