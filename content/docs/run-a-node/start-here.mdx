...
If you're running a beacon node, historical data will now be in <a data-quicklook-from="blob">blobs</a>. To make this transition to using historical blobs, refer to the [Historical Blobs for Beacon Nodes](/docs/run-a-node/beacon-nodes-historical-blobs) guide.
