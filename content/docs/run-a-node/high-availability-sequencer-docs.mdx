...
2. **Nitro full nodes**: Process read requests and forward write transactions
...
<VanillaAdmonition type="warning" title="Never register the batch poster">
...
<VanillaAdmonition type="warning" title="Redis persistence">
