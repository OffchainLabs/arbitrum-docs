...
This documentation is for production sequencer deployments. If you want to set up a sequencer for testing or on a testnet, please refer to [How to run a testnet sequencer node](/docs/run-a-node/sequencer/run-sequencer-node).
...
For the full set of coordinator flags and their defaults, see the [sequencer configuration reference](/docs/run-a-node/nitro/cli-flags-reference#node).
...
For a full diagnostic path, see the sequencer troubleshooting guide.
