...
<VanillaAdmonition type="note">One of the sequencers is marked with a `chosen` indicator. This visual cue helps you identify the current chosen sequencer.</VanillaAdmonition>
