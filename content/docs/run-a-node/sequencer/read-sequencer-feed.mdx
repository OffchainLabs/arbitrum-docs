...
This page covers the standard sequencer feed, which publishes complete blocks and is free to consume. Arbitrum One also offers the <Term id="fast-feed">Fast Feed</Term>, a paid stream that publishes individual transactions before their block closes. See the [introduction to the Fast Feed](/docs/how-arbitrum-works/priority-gas-auction/fast-feed) to compare the two.
