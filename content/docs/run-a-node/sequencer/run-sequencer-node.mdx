...
We also provide a [guide for running a high-availability sequencer node for an Arbitrum chain](/docs/run-a-node/high-availability-sequencer-docs).
      ...
      "da": {
        "anytrust": {
          ...
          "rpc-aggregator": {
            "enable": true,
            "assumed-honest": 1,
            "backends": "[{\"url\":\"http://das-server:9876\",\"pubkey\":\"\"}]"
          }
        }
      }
    },
