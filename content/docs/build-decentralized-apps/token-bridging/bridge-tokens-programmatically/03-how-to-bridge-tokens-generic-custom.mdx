...
As stated in the [token bridge conceptual page](/docs/build-decentralized-apps/token-bridging/03-token-bridge-erc20#the-arbitrum-generic-custom-gateway), there are a few prerequisites to keep in mind while using this method to make a token bridgeable.
