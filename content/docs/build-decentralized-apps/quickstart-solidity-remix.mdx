...
<VanillaAdmonition type="caution" title="Never share your private keys">
...
For a list of learning resources, repositories, and useful information about Solidity, see the [Solidity references](/docs/arbitrum-essentials/reference/solidity-references) page.
